...
<div class="login_c">
         <s:form id="login_form" action="loginTqc" method="post">
    	<table cellpadding="0" cellspacing="0" class="login_table">
            ...
            <tr>
                ...
                <td><s:textfield id="encode" value="" name="encode" cssStyle=" height: 20px; width: 138px;" maxlength="12"/></td>
            ...
            <tr>
            	<!-- <td class="login_txt"></td> -->
                <td colspan="3" style="padding-left:18px;"><a id="loginbtn" href="#" onclick="submitForm()" class="tabtnLink_sure"><img src="../newimages/login_btn.png" /></a></td>
            </tr>
    ...
    <p>豫ICP备05018144号&nbsp;&nbsp;&nbsp;版权所有©宇通集团2013-2014</p>
    </div>
