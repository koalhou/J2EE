<div id="pageCtrl">
	  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		modalDialog('${url}?<#if detailNumParam != "">${detailNumParam}&</#if>detailPage=${detailPage}&detailPageSize=' + this.options[this.selectedIndex].value);
	}">
		${detailNumPage}
		...
		modalDialog( '${url}?<#if param != "">${param}&</#if>detailPage=' + this.options[this.selectedIndex].value);
	}">
		${detailJumpPage}
	</select> 页				  </td>
	    </tr>
