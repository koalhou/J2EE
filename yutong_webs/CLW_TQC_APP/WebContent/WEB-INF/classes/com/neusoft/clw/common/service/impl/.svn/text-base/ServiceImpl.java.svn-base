...
public class ServiceImpl implements Service {
    ...
    public String batchCanelCars(List < VehcileInfo > obj) throws SQLException {
        try {
            return affairDao.batchCanleVel(obj);
        } catch (Exception e) {
            LOG.error(e);
            throw new SQLException(INFO_DB_ERROR);
        }
    ...
    public void updateTqcBatch(String statment, Object obj)
            throws BusinessException {
        try {
            dao.updateTqcBatch(statment, obj);
        } catch (DataAccessIntegrityViolationException e) {
            LOG.error(e);
            throw new BusinessException(INFO_INTEGRITY_VIOLATION_ERROR);
