...
<div id="wrapper">
	...
	<div id="content">
		<s:form id='add_form' method="post" action="areasite_add">
		<s:hidden name="page" />
		...
		<div id="main" style="overflow: auto;">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        <td  height="36"  valign="top">
					  <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
		 				 <tr>
		            		<td height="38" background="../images/contentTil_bg.gif"><span class="contentTil">分配站点</span></td>
		         		 </tr>
					  </table>
		        </td>
		      </tr>
			  ...
			  <table  class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		          <tr>
		            <td height="32" background="../images/msg_title_bg.gif"><span class="msgTitle">&nbsp;&nbsp;分配站点</span></td>
		          </tr>
		          <tr>
		            <td align="center">
		            <table width="100%" border="0" cellspacing="10" cellpadding="0">
		              <tr>
		                <td width="21%" align="right">分配大区：</td>
		                <td width="79%" align="left"  valign="top">
		                <s:select cssStyle="width:90px;" id="areaId" name="areaId" list="areaInfosMap" headerKey="" headerValue="%{getText('please.select')}" onchange="change_l_r_site();"></s:select>
		              ...
		              <tr>
		                <td width="21%" align="right">分配站点：</td>
		                <td align="left">
						<table id="tableos" style="width: 100%;"
							align="left">
							<tr>
								<td>
								<s:select id="selectLeftos" name="selectLeftos" list="leftList" listKey="site_id" listValue="site_name" size="10" multiple="true" cssStyle="width:210px;height:200px;" ondblclick="javascript:moveSelect(this, document.getElementById('selectRightos'),'os');"/>
								...
								<td><select id="selectRightos" name="selectRightos" multiple="multiple" size="10" style="width: 210px;height:200px;" ondblclick="javascript:deleteSelect(document.getElementById('selectLeftos'),this,'os');"></select>
								<select id="ostype" name="site_ids" style="display:none;" multiple="multiple" size="10" class="s"></select></td>
							</tr>
						</table>				
						</td>
					  </tr>
		           ...
		           <tr>
		            ...
		            <a href="#" onclick="goBack('areaReady.shtml')" class="buttontwo"><s:text name="button.cancle" /></a> 
...
<%@include file="setsitetoarea_validate.jsp" %>
