...
<body style="background:#FBFBFB;">
	<div id="wrapper">
		...
		<div id="content">
		<div id="center">
		<s:form id='add_form' method="post" action="area_add">
		<div class="titleBar">
		...
		<td valign="top">
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<%-- <tr>
					<td align="right">分配大区：</td>
		                <td align="left"  valign="top">
		                <s:select cssStyle="width:90px;" id="areaId_check" name="areaId" list="areaInfosMap" headerKey="" headerValue="%{getText('please.select')}" onchange="change_l_r_site();"></s:select>
		                	<span class="noticeMsg">*</span>
		                </td>
		                <td><a href="javascript:void(0)" class="buttonMap" onclick="addbutton">查看</a></td>
					</tr> --%>
					<tr><td height="10" /></tr>	
					<tr>
				   ...
				   <tr>
			     		<td>区域名称：</td>
			     		<td align="left">
			     			<input type="text" name="areaInfo.areaName" id="areaName" value="" maxlength="14" style="width:160px;"/>
			     			<span class="noticeMsg">*</span>
						</td>
						<td align="left"><a href="javascript:void(0)" class="buttonMapR" onclick="drawrect();">规划区域</a></td>
						<td align="left">左下&nbsp;&nbsp;经:</td>
						<td align="left">
						<input id="upleftlat" name="areaInfo.min_longitude" readonly="readonly"/>
						<span class="noticeMsg">*</span>
						</td>
						<td align="left">纬:</td>
						<td align="left">
						<input id="upleftlon" name="areaInfo.min_latitude" readonly="readonly" />
						<span class="noticeMsg">*</span>
						</td>
			     	</tr>
					<tr><td height="10" /></tr>
					 <tr>
						...
						<td align="left">
						<input id="downrightlat" name="areaInfo.max_longitude" readonly="readonly"/>
						<span class="noticeMsg">*</span>
						</td>
						<td align="left">纬:</td>
						<td align="left">
						<input id="downrightlon" name="areaInfo.max_latitude" readonly="readonly"/>
						<span class="noticeMsg">*</span>
						</td>
			     	</tr>
					<tr><td height="10" /></tr>
	...
	<%@include file="areaset_validate.jsp"%>
</body>
</html>
