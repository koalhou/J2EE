...
<body>
											...
											<tr>
												<td width="450px">
													<table border="0" cellspacing="4" cellpadding="0">
														<tr>
															<td>班车号：</td>
															<td><s:textfield id="vehicle_code" name="alarmmanage.vehicle_code" cssClass="input80" maxlength="32" onkeypress="if(event.keyCode==13){searchList();}"/></td>
															<td>&nbsp;&nbsp;&nbsp;</td>
															<td>车牌号：</td>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<td width="69%" align="right">
																			<s:if test="#session.perUrlList.contains('111_3_5_14_2')">
																				<div class="buhuanhangbut">
																					<a href="./chooseStudent.shtml"
																					   class="btnAdd"
																					   title="<s:property value="getText('msg.add')" />">
																					</a>
																				</div>
																			</s:if>
																			<s:if test="#session.perUrlList.contains('111_3_5_14_5')">
									                                      		<div class="buhuanhangbut">
									                                      			<a href="#" 
									                                      			   class="btnAllot" 
									                                      			   onclick="sendRouteVin()"
									                                      			   title="<s:text name="下发" />">
									                                      			</a>
									                                      		</div>	
									                                      	</s:if>	
																		</td>
	...
	<form  action="../infomanage/exportTIni.shtml" method="post" name="exportIniForm" id="exportIniForm" enctype="multipart/form-data">
