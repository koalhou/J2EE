...
<div id="wrapper">
	...
	<div id="content">
	<s:form id="add_studentform" action="student_add" method="post" enctype="multipart/form-data">
		<s:hidden name="page" />
			...
			<tr>
				<td valign="top">
					<table class="msgBox2" width="720" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td height="32">
								<span class="msgTitle"><s:text name="student.add.info" /></span>
							</td>
						</tr>
						<tr>
							<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td align="left">
										...
										<s:textfield id="student_birth" name="studentInfo.student_birth" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true})" cssClass="Wdate">
										</s:textfield>
									</td>
								</tr>
								<tr>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td>
										<s:textfield id="teacher_tel" name="studentInfo.teacher_tel" maxlength="20" cssStyle="ime-mode:disabled">
										</s:textfield>
									</td>
								</tr>
							</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td align="left" width="35%">
											<s:textfield id="relative_tel" name="studentInfo.relative_tel" maxlength="20" cssStyle="ime-mode:disabled">
											</s:textfield>
										</td>
									</tr>
									<tr>
						...
						<tr>
							<td class="btnBar">
								<a href="#" class="buttontwo" onclick="goBack('studentmanage.shtml');"><s:text name="button.cancle" /></a> 
...
<%@include file="addstudent_validate.jsp"%>
</body>
</html>
