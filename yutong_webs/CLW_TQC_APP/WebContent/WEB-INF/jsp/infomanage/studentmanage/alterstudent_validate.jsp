...
<script type="text/javascript">
	...
	function submitAlterForm() {
		...
		if (f0 && f1 && f2 && f3 && f5 && f6 && f7 && f8 && f9 && f11 && f12 && f13) {
			...
			if(oldStudentCard.value != newStudentCard.value) {
				// 学生卡号变化时，检查卡号唯一性  
	...
	function onloadFunc() {
		...
		if(photoName != "") {
			...
			preImg.src="<s:url value='show_pic.shtml'/>" + "?student_id=" + document.getElementById("student_id").value;
			document.getElementById("photoPreview").style.display="block";
			document.getElementById("noPhoto").style.display="none";
		}
	}
