...
<div id="wrapper">
  ...
  <div id="content">
  <s:form id="studentImport_form" action="importStudent" method="post" enctype="multipart/form-data">
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
		    <tr>
              <td width="14%" height="28" align="right">所属省： </td>
            ...
            <tr>
              <td width="14%" height="28" align="right">所属市： </td>
              <td class="fsBlack" align="left">
            ...
            <tr>
              <td width="14%" height="28" align="right">所属县区： </td>
              <td class="fsBlack" align="left">
            ...
            <tr>
              ...
              <td class="fsBlack" align="left">
                ...
                <a href="<s:url value='/uploadlogo/StudentrInformation.xls' />"><s:property value="getText('file.template.download')" /></a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td class="btnBar"> 
          <a href="#" class="buttontwo" onclick="goBack('studentmanage.shtml')">
...
<%@include file="studentImport_validate.jsp"%>
</body>
</html>
