							...
							<tr>
								<td>
								  <s:if test="#session.perUrlList.contains('111_3_5_6_4')">
								     考核月度:
								 <s:textfield id="check_time_code" name="ocktimeset.check_time_code" onfocus="WdatePicker({dateFmt:'yyyy-MM',autoPickDate:true,isShowToday:false,onpicked:function(){searchList();}})" cssClass="Wdate">
								</s:textfield>
								</s:if>
								</td>
