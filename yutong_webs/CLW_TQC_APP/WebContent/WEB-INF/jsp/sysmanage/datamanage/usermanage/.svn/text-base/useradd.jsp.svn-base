                      	...
                      	<tr>
                        	<td height="90">
                            	...
                            	<tr>
                              		...
                              		<td width="36%" class="fsBlack"><input type="password" onpaste="return false" oncontextmenu="return false" oncut="return false" id="loginPwd" name="optuserInfo.loginPwd" /><span class="noticeMsg">*</span></td>
                            	</tr>
                           		<tr>
                              		<td width="14%" align="right">确认密码：</td>
              				  		<td width="36%" class="fsBlack">
                					<input type="password" id="confirmPassword" onpaste="return false" oncontextmenu="return false" oncut="return false"/><span class="noticeMsg">*</span></td>
                            	</tr> 
                          		</table>
                        	</td>
                      	</tr>
