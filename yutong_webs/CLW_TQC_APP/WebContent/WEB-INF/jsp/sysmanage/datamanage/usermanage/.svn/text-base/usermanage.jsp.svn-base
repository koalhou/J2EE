	...
	<table id="midarerId" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td valign="top">
	    		...
	    		<input type="hidden"  id="UrlList2" name="UrlList2" value="<s:property value="#session.perUrlList.contains('111_3_5_8_7')"/>" />
						...
						<tr>
							...
							<table  border="0" cellspacing="4" cellpadding="0">
								<tr>
									...
									<td align="left"><s:textfield id="loginName" name="loginName" maxlength="32" onkeypress="if(event.keyCode==13){searchList();}"/></td>
