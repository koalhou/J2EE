		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="35%" class="fsBlack">
                <input type="password" id="password" name="password" cssStyle="width:131px" maxlength="30" onpaste="return false" oncontextmenu="return false"/>
              </td>
            </tr>
            <tr>
              <td width="14%" height="28" align="right">
              ...
              <td width="20%" class="fsBlack">
                <input type="password" id="confirmPassword" name="confirmPassword" cssStyle="width:131px" maxlength="30" onpaste="return false" oncontextmenu="return false"/>
              </td>
            </tr>
          </table>
        </td>
