					...
					<tr>
						...
						<table border="0" cellspacing="4" cellpadding="0">
							<tr>						
								<td>
								学号：
								<s:textfield id="stu_code" name="info.stu_code" cssClass="input120" onkeypress="if(event.keyCode==13){searchStudent();}"/>&nbsp;&nbsp;
								</td>
								<td>
								姓名：
								<s:textfield id="stu_name" name="info.stu_name" cssClass="input120" onkeypress="if(event.keyCode==13){searchStudent();}"/>&nbsp;&nbsp;
								</td>					
							</tr>
							<tr><td>
								学校：
								<s:textfield id="stu_school" name="info.stu_school" cssClass="input120" onkeypress="if(event.keyCode==13){searchStudent();}"/>&nbsp;&nbsp;
								</td>
							    <td>
								班级：
								<s:textfield id="stu_class" name="info.stu_class" cssClass="input120" onkeypress="if(event.keyCode==13){searchStudent();}"/>
								</td>	
...
function searchStudent() {
	...
	jQuery('#gala').flexOptions({
		newp: 1,
		params: [{name: 'info.stu_name', value: jQuery('#stu_name').val() },
		         {name: 'info.stu_code', value: jQuery('#stu_code').val() },
		         {name: 'info.stu_school', value: jQuery('#stu_school').val() },
		         {name: 'info.stu_class', value: jQuery('#stu_class').val() },	
		         {name:'stu_id',value: jQuery('#stu_id').val()}		 		
			 	]
	});
...
jQuery(function() {
	 ...
	 gala.flexigrid({
	  ...
	  colModel : [ 
	        ...
	        {display: '学号',name : 'stu_code', width : 60, sortable : false, align: 'center'}, 
	        {display: '姓名', name : 'stu_name', width : 128, sortable : false, align: 'center'},	       
	        {display: '学校', name : 'stu_school', width : 100, sortable : false, align: 'center'},
	        {display: '班级', name : 'stu_class', width : 200, sortable : false, align: 'center'},	       
