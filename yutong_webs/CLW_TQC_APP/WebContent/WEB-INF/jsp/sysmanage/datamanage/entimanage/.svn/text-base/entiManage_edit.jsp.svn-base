					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
						  <td align="right">&nbsp;</td>
							...
							<td width="239" align="left"><label><s:select id="ENTERPRISE_PROVINCE" name="enterpriseDataInfo.enterprise_province" list="provinceInfosMap" headerKey="" headerValue="%{getText('please.select')}" onchange="show_enterprise_city()">
						  </s:select></label></td>
						...
						<tr>
						  ...
						  <td align="left"><label> <input type="text" id="CONTACT_TEL"
								name="CONTACT_TEL"  maxlength="16" value="<s:property value="enterpriseDataInfo.contact_tel" />"> </label></td>
						</tr>
						<tr>
						...
						<tr>
						  ...
						  <td height="28" align="right" valign="top"><s:text name="enterprise.info.ENTERPRISE_DESC" />:</td>
							<td colspan="5" align="left"><label> <textarea
								id="ENTERPRISE_DESC" name="ENTERPRISE_DESC" cols="67" rows="6"><s:property value="enterpriseDataInfo.enterprise_desc" /></textarea>
