				...
				<td valign="top">
					    ...
					    <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<div class="buhuanhangbut"><a href="<s:url value='addRoleBefore.shtml' />" class="btnAdd" title="<s:text name="button.create" />"></a></div>
												</td>
												<td width="1%">&nbsp;</td>
										       </tr>
										      </table>
						 ...
						 <table width="100%" border="0" cellspacing="0" cellpadding="0">
		                     <tr>
		                      ...
		                      <s:actionerror cssStyle="font-size: 12px; color: #CC0000"  /></td>
		                                        </tr>
		                                      </table>
...
function autoWidthHeight(){
	...
	// jQuery(".flexigrid").width(w-25);
	 ...
	 if(jQuery(window).width()>1410) {
		 ...
		 jQuery(".flexigrid").width(jQuery(window).width()-30);
	 }else {
		 jQuery("#tabAreaId").width(jQuery("#header").width()-30);
