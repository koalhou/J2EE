...
<body>
	...
	<%@include file="/WEB-INF/jsp/common/header.jsp"%>
		<div id="content">
			<div id="main">
			  ...
			  <s:hidden id="oldroutename" name="oldrouteName"/>
				              ...
				              <td>
				                ...
				                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
							            ...
							            <tr>
							              ...
							              <td align="left">
							                <input id="route_name" name="routeInfo.route_name" maxlength="14" onkeypress="TextValidate()"/><span class="noticeMsg">*</span>
							              </td>
							            </tr>
							            <tr>
							       ...
							       <tr id="maptoolbar" >
							         <td height="30" align="center" background="../images/fudong_bg_station.png" style=" border-left:1px solid #4573BE;">
							          <table border="0" cellpadding="0" cellspacing="0">
										...
										<td>
										<input type="checkbox" id="showRouteStation" onclick="initMapEditList();"/>显示线路站点&nbsp;
										站点:
										<input type="text" id="showStation" maxlength="10" size="10" onkeypress="if(event.keyCode==13){initMapList();}"/>
										&nbsp;时间段:
	...
	<script type="text/javascript">
		...
		function openorganizidtree(){
			art.dialog.open("route/routemanagetree.shtml",{
				title:"选择部门",
				lock:true,
				width:250,
				height:300,
