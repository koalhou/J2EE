		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td align="left" class="subnavLeft">
					<s:property value="getText('main.current')" />：基础数据</td>
				<td>&nbsp;</td>
			</tr>
		</table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="36" valign="top" background="../images/tree_tabBg.gif">
								<div class="toolbar">
									<div class="contentTil">基础数据</div>
								</div>
							</td>
						</tr>
					</table>
					<table id="forbidTbl" width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="center" bgcolor="#F0F0F0" valign="middle">
								<img src="../images/stop.jpg" alt="" />
								<b><font size="6">未经过验证，无操作权限！</font></b>
							</td>
						</tr>
					</table>
				</td>
...
<%@include file="employeeforbid_js.jsp"%>
</body>
</html>
