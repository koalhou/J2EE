...
<div id="wrapper">
  ...
  <div id="content">
  <s:form id="studentImport_form" action="importEmployee" method="post" enctype="multipart/form-data">
    <s:hidden id="page" name="page" />
    <s:hidden id="pageSize" name="pageSize" />
    
    <table id="studentTable" width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
    ...
    <div id="Below_new" style="text-align:center;color:#cc0000" /></div>
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center">
		  ...
		  <tr>
			  <td width="14%" height="28" align="right">所属组织：</td>
            ...
            <tr>
              ...
              <td class="fsBlack" align="left">
                ...
                <a href="<s:url value='/uploadlogo/EmployeeInformationInput.xls' />"><s:property value="getText('file.template.download')" /></a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td class="btnBar"> 
          <a href="#" class="buttontwo" onclick="goBack('employeemanage.shtml')">
...
<%@include file="employeeImport_validate.jsp"%>
</body>
</html>
