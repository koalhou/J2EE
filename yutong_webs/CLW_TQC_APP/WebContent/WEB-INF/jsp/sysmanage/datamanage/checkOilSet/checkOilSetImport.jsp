...
<div id="wrapper">
	...
	<div id="content">
	  <s:form id="driverImport_form" action="importCheckOilInfo" method="post" enctype="multipart/form-data">
	    ...
	    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	            <tr>
	              ...
	              <td class="fsBlack" align="left">
	                ...
	                <a href="<s:url value='/uploadlogo/CheckOilSetModel.xls' />"><s:property value="getText('file.template.download')" /></a>
	              </td>
	            </tr>
	          </table>
	        </td>
	      ...
	      <tr>
	        <td class="btnBar"> 
	          <a href="#" class="buttontwo" onclick="goBack('checkOilSetInit.shtml')">
...
<%@include file="checkOilSetImport_validate.jsp"%>
</body>
</html>
