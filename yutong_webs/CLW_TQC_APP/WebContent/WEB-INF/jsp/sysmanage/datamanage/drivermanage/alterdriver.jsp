...
<!--								</s:if>-->
								...
								<tr>
									...
									<td align="left">
										<s:property id="vehicle_ln" value="driverInfo.vehicle_ln" />
									</td>
								</tr>
								...
								<tr>
									...
									<td align="left">
										<input id="driver_birth" value="${driverInfo.driver_birth}" name="driverInfo.driver_birth" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endTimehidden\')}',isShowToday:false,autoPickDate:true})" class="Wdate" />
									</td>
								</tr>
								<tr>
						...
						<tr>
							<td class="btnBar"><a href="#"
								...
								name="button.cancle" /></a> 
								<s:if
								test="#session.perUrlList.contains('111_3_5_5')">
							...
							</s:if> <s:if test="#session.perUrlList.contains('111_3_5_5')">
