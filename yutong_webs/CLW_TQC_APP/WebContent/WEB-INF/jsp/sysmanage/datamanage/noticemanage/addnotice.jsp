...
<div id="wrapper">
	...
	<div id="content">
		<s:form id="addnoticeform" action="addNotice" method="post" enctype="multipart/form-data">
			<s:hidden name="page" />
				...
				<tr>
					<td valign="top">
						...
						<table class="msgBox2" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 760px;">
							<tr>
								<td height="32">
									<span class="msgTitle"><s:text	name="新建公告" /></span>
								</td>
							</tr>
							<tr>
								<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="130px" class="fsBlack">
											<input id="gonggaoDate"
												...
												onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowToday:false,maxDate:'#F{$dp.$D(\'gonggaoDate\')}',autoPickDate:true})"
												class="Wdate" /> 
									...
									<tr>
										...
										<td align="left" class="fsBlack">
											<s:textfield id="gonggaoTitle" name="gonggao.gonggaoTitle"  maxlength="40" size="70">
											</s:textfield>
									...
									<tr>
										...
										<td align="left" class="fsBlack">
											<s:textarea id="gonggaoSummary" name="gonggao.gonggaoSummary" rows="5" cols="60">
											</s:textarea>
											200字以内
