...
function gethtml(TerminalViBean){
	...
	var httpinfo = "";//"<div  style='width:240px; height:140px;top:8px;left:6px;'>";
	    ...
	    if(TerminalViBean.DRIVER_TEL!=null&&TerminalViBean.DRIVER_TEL.length>0){
			httpinfo += "<td width='24%'><strong>"+TerminalViBean.DRIVER_TEL+"</strong></td>";
		}else{
	   		httpinfo += "<td width='24%'><strong>未知</strong></td>";
		}
