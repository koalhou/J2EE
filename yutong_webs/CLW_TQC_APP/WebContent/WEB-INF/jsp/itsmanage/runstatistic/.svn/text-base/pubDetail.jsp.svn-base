...
<s:hidden id="subVin" name="pub.vehicle_vin"></s:hidden>
<s:hidden id="subStart_time" name="pub.start_time"></s:hidden>
<s:hidden id="subEnd_time" name="pub.end_time"></s:hidden>
			     ...
			     <tr>
			        ...
			        <table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tr>
                         ...
                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="30%" class="titleStyleZi">公差详情信息</td>
...
jQuery(function() {
	 ...
	 var url= "../runStatisticList/pubDetailListJson.shtml";
	 gala.flexigrid({
	  url: '<s:url value="'+url+'" />', 
	  dataType: 'json',    //json格式
	  params : [ {
			name : 'pub.vehicle_vin',
	  ...
	  colModel : 
		  [ {display: '序号', name : 'rowNumber', width : calcColumn(0.02,40,0),align: 'center'},
	        ...
	        {display: '乘车人数', name : 'count', width : calcColumn(0.08,60,0), sortable : true, align: 'center'},
	        ...
	        {display: '总里程', name : 'mileage', width : calcColumn(0.08,80,0), sortable : true, align: 'center'},
	        {display: '驾驶员', name : 'driver_name', width : calcColumn(0.08,110,0), sortable : true, align: 'center'}
	        ],
	       sortname: 'start_time',
