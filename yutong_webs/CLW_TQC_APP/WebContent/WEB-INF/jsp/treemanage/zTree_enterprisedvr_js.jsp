...
<script>
	...
	function addDiyDom(treeId, treeNode) {
		...
		if (treeNode.dvrState == "offdvr") {
			...
			var editStr = "<s:if test='#session.perUrlList.contains(\"111_3_1_11\")'><span id='diyBtn_" +treeNode.id+ "' name='"+ treeNode.id + "' class='button icon01' style=''></span></s:if>";
			aObj.after(editStr);
			...
			var editStr = "<s:if test='#session.perUrlList.contains(\"111_3_1_11\")'><span id='diyBtn_" +treeNode.id+"' name='"+ treeNode.id + "' class='button icon02' style=''></span></s:if>";
			aObj.after(editStr);
			var btn = jQuery("span[name='"+ treeNode.id + "']");
			if (btn) btn.bind("click", function(){dvrButtonOnclick(treeNode);});
		}
