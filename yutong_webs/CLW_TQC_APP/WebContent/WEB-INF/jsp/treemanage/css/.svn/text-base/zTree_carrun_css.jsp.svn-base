...
.ztree li button.online_ico_docu{margin-right:4px;width:31px;line-height: 16px; background: url(../images/online_ico_docu.png) no-repeat scroll 0 0 transparent; vertical-align:middle; *vertical-align:middle}
.ztree li button.offline_ico_docu{margin-right:4px;width:31px;line-height: 16px; background: url(../images/ico_SB_offline.png) no-repeat scroll 0 0 transparent; vertical-align:middle; *vertical-align:middle}
</style>