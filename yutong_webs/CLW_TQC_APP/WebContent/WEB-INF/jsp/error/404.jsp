...
.answer div{ width:550px; margin:0 auto;}
...
<body>
  ...
  <div class="navbar">
    <div id="companyLogo" style="background: url(/images/company_logo.jpg) no-repeat left center;">
    </div>
  </div>
      ...
      <td width="50%" align="center">
        <table width="900" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="40">
              <span class="STYLE4">
                <img src="/CLW_TQC_APP/images/erro.jpg" width="50" height="49" align="middle">无法找到该页面
              </span>
            </td>
          </tr>   
          <tr>
            <td height="40">
              <span class="STYLE5">你正在搜索的页面可能已经删除、更名或暂时不可用。</span>
            </td>
          </tr>        
          <tr>
          ...
          <tr>
            <td align="center">
              <img src="/CLW_TQC_APP/images/404.gif" width="677" height="224">
            </td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
