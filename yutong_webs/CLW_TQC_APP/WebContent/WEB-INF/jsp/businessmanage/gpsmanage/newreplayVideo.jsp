...
<head>
	...
	<style>
		...
		.position2{display:block; width:36px; line-height:23px; float:left;padding-top: 4px;}
		.setpath_iframe{ 
			position:absolute; 
			visibility:inherit; 
			top:0; left:0;
...
<div class="popArea" style="width: 100%; height: 100%">
	...
	<div class="line_spacing">
		...
		<div class="check_box">
			...
			<div><span class="position1"><input name="routeway2" type="checkbox" value="4" /></span><span class="position2">驾驶员</span></div>
		</div>
		<div class="list-sech2" style="width:80px;">
			<a href="#" class="btn-blue" onfocus="this.blur()" onclick="selectgj();" style="margin-right: 15px;">查询</a>
		</div>
	</div>
</div>
...
<div id="map" style="height:100%;">
	...
	<s:if test="terminalViBeanV.VIDEO_FACTORY=='DA'">
		<div id="ocxDA" style="width:100%;height:280px;">
		   	  <object id="ocx" width="100%" height="280px" classid='CLSID:C2F93B39-9404-47A9-B254-2F64753B06DC' 
