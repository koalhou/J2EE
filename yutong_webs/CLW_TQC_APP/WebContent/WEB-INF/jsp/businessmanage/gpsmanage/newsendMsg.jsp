...
<s:hidden  id="vin" name="terminalViBean.VEHICLE_VIN"/>
  ...
  <div id="showArea1" class="line_spacing2">
    ...
    <div class="check_box">
      ...
      <div><span class="position0"><input name="InfoType" type="checkbox" id="1" checked="checked"  value="1" /></span><span class="position2">语音播报</span></div>
    ...
    <div id="showArea3" class="line_spacing2">
	    <div>
			<textarea id="msg" name="msg" rows="4"  class="sub-form2" onkeyup="gbcount(this)" onkeydown="gbcount(this)" onmouseout="gbcount(this)"  ></textarea> 
		</div>  	 
    </div>
