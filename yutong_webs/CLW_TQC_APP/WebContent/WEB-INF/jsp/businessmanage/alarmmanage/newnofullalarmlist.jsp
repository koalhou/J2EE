                               ...
                               <div class="car-status-alarm">
              	              <!--dyy_20120817 start-->
                                    <table  border="0" cellspacing="0" cellpadding="0">
  					                    <tr>
<!--   					                    	 <td class="alarm_title">车牌号：</td> -->
<!--     					                     <td width="120"><input id="alarmVehicleLn" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td> -->
...
<!--     					                     <td class="alarm_title1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;告警时间：</td> -->
    					                     <td width="120" style="display:none;"><input id="alarmTime" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
    					                     <td class="alarm_title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;行驶线路：</td>
                                             ...
                                             <td class="alarm_title">非时发车站点：</td>
                                             <td width="120"><input id="zhandian" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title">实际发车时间：</td>
                                             <td width="120"><input id="zhijishijian" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
<!--                                              <td class="alarm_title">&nbsp;&nbsp;&nbsp;处理人：</td>	 -->
<!--     					                     <td width="120"><input id="alarmProPerson" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td> -->
  					                     ...
  					                     <tr>
                                             ...
                                             <td class="alarm_title">计划发车时间：</td>
    					                     <td><input id="jihuashijian" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                    	                     <td class="alarm_title">&nbsp;&nbsp;&nbsp;发车时间差：</td>
    					                     <td><input id="tiqianshijian" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
    					                     <td class="alarm_title3"></td>
                                             <td></td>
                                             <td class="alarm_title3"></td>
  					                     </tr>
				                      </table>
                ...
                <!--dyy_20120817 end-->
                                 ...
                                 <a id="deal5" href="javascript:void(0);" onclick="changetab(this,5)" class="alarm_tabs">非时发车告警</a>
                                 </s:if>
                                 ...
                                 <a id="deal8" href="javascript:void(0);" onclick="changetab(this,8)">油量告警</a>
                                  ...
                                  <div class="alarm_select">
                                      ...
                                      <s:select id="alarm_type_id" name="alarm_type_id"
											list="alarmtypemap"
											headerKey=""
											headerValue="%{getText('please.select')}" cssStyle="width:100px;height:20px;" onchange="mychange()"/>
									  </div>
...
<!-- 				                       <option value="2">处理中</option> -->
                                     ...
                                     <!-- 下面是列表不细作,不使用 -->
		                              ...
		                              <%@include file="newnofullalarmlist_js.jsp"%>