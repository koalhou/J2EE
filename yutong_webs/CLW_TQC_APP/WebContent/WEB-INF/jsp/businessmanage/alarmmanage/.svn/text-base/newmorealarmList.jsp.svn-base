...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:hidden id="newveh_ln" name="newveh_ln" />
					...
					<td valign="top"  class="position_r" id="rightdiv">
					 <div id="content_rightside">
					     <div class="titleBar">
							...
							<div class="workLink">
							    <div id="piliangchuli" style="display:block;">
                                   <a id="proccessAlarm" href="javascript:void(0);" class="squarLink"  onclick="senddealcommand()">
                                   <img src="<s:url value='../images/btn_tool/btn_operate.png'/>" align="bottom" />
                                                                                          批量处理</a> 
                                </div>
                                 <div>
                                    <a href="javascript:void(0);" class="squarLink" onclick="exportAlarm()">
                                    <img src="<s:url value='../images/btn_tool/btn_export.png'/>" align="bottom"/>导出</a>
                                 </div>
                            </div>
                         </div>
                        <div id="statusManger">
			...
			<s:hidden id="alarmmanage.sortname" name="alarmmanage.sortname"/>
			<s:hidden id="alarmmanage.sortorder" name="alarmmanage.sortorder"/>
			
			<s:hidden id="tqcalarm.sortname" name="tqcalarm.sortname"/>
			<s:hidden id="tqcalarm.sortorder" name="tqcalarm.sortorder"/>
			</s:form>				
</div>
