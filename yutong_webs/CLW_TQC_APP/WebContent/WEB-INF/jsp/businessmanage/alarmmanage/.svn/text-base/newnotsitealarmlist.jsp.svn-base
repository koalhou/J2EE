...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
              	              ...
              	              <!--dyy_20120817 start-->
                                    <table  border="0" cellspacing="0" cellpadding="0">
  					                    <tr>
                                             ...
                                             <td class="alarm_title3">&nbsp;&nbsp;&nbsp;上一站：</td>
                                             <td><input id="upSite" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title3">&nbsp;&nbsp;&nbsp;下一站：</td>
                                             <td width="120"><input id="downSite" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                     ...
  					                     <tr>
                                             ...
                                             <td width="120"><input id="siji" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title3">告警位置：</td>  
    					                     <td width="330" colspan="3"><input id="diliweizhi" type="text" style="background:url(../newimages/input_bg_311.png) no-repeat left top; border:none; width:306px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                     </tr>
				                      </table>
                ...
                <!--dyy_20120817 end-->
                                 ...
                                 <a id="deal1" href="javascript:void(0);" onclick="changetab(this,6)" class="alarm_tabs">站外开门告警</a>
                                 </s:if>
...
<!-- 				                       <option value="2">处理中</option> -->
                                     ...
                                     <!-- 下面是列表不细作,不使用 -->
		                              ...
		                              <%@include file="newnotsitealarmlist_js.jsp"%>