...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
              	              ...
              	              <!--dyy_20120817 start-->
                                    <table border="0" cellspacing="0" cellpadding="0">
                                    	<tr>
    					                     ...
    					                     <td width="120"><input id="alarmtypename1" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title3">核载人数：</td>
    					                     <td width="120"><input id="countPerson" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
    					                     <td class="alarm_title3">&nbsp;&nbsp;&nbsp;驾驶员：</td>
    					                     <td width="120"><input id="alarmDriver" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
    					                     <td class="alarm_title3">处理意见：</td>
  					                    ...
  					                    <tr>
    					                     ...
    					                     <td width="336" colspan="3"><input id="alarmAddr" type="text" style="background:url(../newimages/input_bg_311.png) no-repeat left top; border:none; width:306px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                    </tr>
				                      </table>
                ...
                <!--dyy_20120817 end-->
           	                    ...
           	                    <div class="alarm_tab">
                                 <a id="deal0" href="javascript:void(0);" onclick="changetab(this,1)" class="alarm_tabs">紧急告警</a>
...
<!-- 											 headerValue="%{getText('please.select')}" -->
                                      ...
                                      <div class="alarm_sel_c"><input readonly="readonly" id="end_time" name="end_time"
											...
											onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true,minDate:'#F{$dp.$D(\'start_time\')}',maxDate:'#F{$dp.$D(\'end_time_hidden\')}',isShowToday:false,isShowClear:false,onpicked:pickedendtime})" /></div>
                                     ...
                                     <!-- 下面是列表不细作,不使用 -->
				                       ...
				                       <%@include file="newsosalarmlist_js.jsp"%>