...
<script type="text/javascript">
	/**点击查询按钮**/
	function searchList() {
		var paramsv =  [{name: 'vehicle_ln', value: jQuery('#vehicle_ln').val().trim() }, 
		    ...
		    if(jQuery('#deal_flag').val() == '1' && jQuery('#alarm_type_id').val()!='\'40\'' && jQuery('#alarm_type_id').val()!='\'32\'') {
		    ...
		    }else if(jQuery('#deal_flag').val() == '1' && jQuery('#alarm_type_id').val()=='\'32\'') {
		    	jQuery('#gala').flexOptions({
					newp: 1,
					params: paramsv,
		    ...
		    else if(jQuery('#alarm_type_id').val()=='\'32\''||jQuery('#alarm_type_id').val() == '\'40\'') {
		    	jQuery('#gala').flexOptions({
					newp: 1,
					params: paramsv,
					sortname:"alarm_time",
		    ...
		    }else if(jQuery('#alarm_type_id').val()=='\'010\',\'001\'' || jQuery('#alarm_type_id').val()=='\'001\'') {
		    	jQuery('#gala').flexOptions({
					newp: 1,
					params: paramsv,
