...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
              	              ...
              	              <!--dyy_20120817 start-->
                                    <table border="0" cellspacing="0" cellpadding="0">
                                    	<tr>
    					                     ...
    					                     <td width="120"> <input id="alarmtypename1" type="text" style="background:url(../newimages/input_bg_118.png) no-repeat left top; border:none; width:120px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title3">变动油量：</td>
    					                     <td width="120"><input id="changeOil" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                    ...
  					                    <tr>
    					                     ...
    					                     <td width="330" colspan="3"><input id="alarmAddr" type="text" style="background:url(../newimages/input_bg_311.png) no-repeat left top; border:none; width:306px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                    </tr>
				                      </table>
                ...
                <!--dyy_20120817 end-->
                                 ...
                                 <a id="deal8" href="javascript:void(0);" onclick="changetab(this,8)" class="alarm_tabs">油量告警</a>
                                 </s:if>
                                </div>
...
<!-- 				                       <option value="2">处理中</option> -->
                                     ...
                                     <!-- 下面是列表不细作,不使用 -->
				                       ...
				                       <%@include file="newoilalarmlist_js.jsp"%>