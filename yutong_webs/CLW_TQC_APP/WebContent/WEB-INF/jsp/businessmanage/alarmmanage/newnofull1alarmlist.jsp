...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
              	              ...
              	              <!--dyy_20120817 start-->
                                    <table  border="0" cellspacing="0" cellpadding="0">
  					                    <tr>
                                             ...
                                             <td class="alarm_title3">空余座数：</td>
    					                     <td width="120"><input id="kongzuo" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title">未满发车站点：</td>
  					                     ...
  					                     <tr>
    					                     ...
    					                     <td><input id="hezairenshu" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
    					                     <td class="alarm_title3">实载人数：</td>
    					                     <td><input id="shizairenshu" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
  					                     </tr>
				                      </table>
                ...
                <!--dyy_20120817 end-->
	                             ...
	                             <a id="deal7" href="javascript:void(0);" onclick="changetab(this,7)" class="alarm_tabs">未满发车告警</a>
	                             </s:if>
...
<!-- 				                       <option value="2">处理中</option> -->
                                     ...
                                     <!-- 下面是列表不细作,不使用 -->
		                              ...
		                              <%@include file="newnofull1alarmlist_js.jsp"%>