...
<title>欢迎使用宇通通勤车管理系统</title>
<link rel="stylesheet" type="text/css" href="<s:url value="/stylesheets/global1.css" />" />
<link rel="stylesheet" type="text/css" href="<s:url value="/stylesheets/login.css" />" />
...
<div class="login_c">
         ...
         <s:textfield id="encode" value="0000600001" name="encode" cssStyle=" height: 20px; width: 138px;" maxlength="12"/>
          <span id="endesc"></span>
         </div>
    	<table cellpadding="0" cellspacing="0" class="login_table">
            ...
            <%-- <tr>
                ...
                <td><s:textfield id="encode" value="600001" name="encode" cssStyle=" height: 20px; width: 138px;" maxlength="12"/></td>
            ...
            <tr>
              ...
              <tr>
              <td>
              <s:textfield id="validateCode" name="validateCode" cssStyle=" height: 20px; width: 65px;" maxlength="4"/></td>
              <td>&nbsp;&nbsp;
              <img
            ...
            <tr>
            	<!-- <td class="login_txt"></td> -->
                <td colspan="3"><a id="loginbtn" href="#" onClick="submitForm()" class="login_btn"><img src="newimages/login_btn.png" /></a></td>
            </tr>
        </table>
        ...
        <div id="miaoshu" class="miaoshu" style="display:none;position:absolute;left:750px;top:280px;"><s:actionerror theme="mat" /><s:fielderror theme="mat" /></div>
        </s:form>
    </div>
    ...
    <p>豫ICP备10203497号-3&nbsp;&nbsp;&nbsp;版权所有©宇通集团2013-2014</p>
    </div>
    ...
    <script type="text/javascript"> 
		...
		function getCookie(){
			...
			var entid = '600001';//jQuery.cookie('entid');
