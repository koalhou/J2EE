/**
 * BS_KYPT_SI_SernrInfo_OutLocator.java
 *
...
public class BS_KYPT_SI_SernrInfo_OutLocator extends org.apache.axis.client.Service implements com.neusoft.clw.yw.webservice.BS_KYPT_SI_SernrInfo_Out {

    public BS_KYPT_SI_SernrInfo_OutLocator() {
    }


    public BS_KYPT_SI_SernrInfo_OutLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public BS_KYPT_SI_SernrInfo_OutLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://pitest1.yutong.com:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_KYPT&receiverParty=&receiverService=&interface=SI_SernrInfo_Out&interfaceNamespace=http%3A%2F%2Fyutong.com%2Fesb%2Fkypt%2Fecc%2FSernrInfo&j_username=huazy&j_password=yt123456";
    ...
    private java.lang.String HTTP_Port_address = "http://pitest1.yutong.com:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_KYPT&receiverParty=&receiverService=&interface=SI_SernrInfo_Out&interfaceNamespace=http%3A%2F%2Fyutong.com%2Fesb%2Fkypt%2Fecc%2FSernrInfo&j_username=huazy&j_password=yt123456";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://yutong.com/esb/kypt/ecc/SernrInfo", "BS_KYPT_SI_SernrInfo_Out");
    }
