...
public final class Constants {
    ...
    public static final String USER_THEME_KEY = "themeProfile";
    ...
    public static final Map < String, String > SEX_SYS_MAP = new LinkedHashMap < String, String >();
    ...
    public static final Map < String, String > ALARM_TAB4_TYPE_MAP = new HashMap < String, String >();

    public static final Map < String, String > ALARM_TAB5_TYPE_MAP = new HashMap < String, String >();
    
    public static final Map < String, String > ALARM_TAB6_TYPE_MAP = new HashMap < String, String >();
    
    public static final Map < String, String > ALARM_TAB7_TYPE_MAP = new HashMap < String, String >();
	...
	public static final Map < String, String > ALARM_TAB3_TYPE_MAP_NEW = new HashMap < String, String >();
	
	public static final Map < String, String > ALARM_TAB4_TYPE_MAP_NEW = new HashMap < String, String >();
	
	public static final Map < String, String > ALARM_TAB5_TYPE_MAP_NEW = new HashMap < String, String >();
	
	public static final Map < String, String > ALARM_TAB6_TYPE_MAP_NEW = new HashMap < String, String >();
	
	public static final Map < String, String > ALARM_TAB8_TYPE_MAP_NEW = new HashMap < String, String >();
	
	public static final Map < String, String > ALARM_DEAL_FLAG_MAP_NEW = new HashMap < String, String >();
...
//        ALARM_TAB1_TYPE_MAP.put("'72'", "超载告警");
    ...
    static {
    	ALARM_TAB3_TYPE_MAP_NEW.put("2", "提前发车");//非时发车2,5
    	ALARM_TAB3_TYPE_MAP_NEW.put("5", "延迟发车");
    }
    
    static {
    	ALARM_TAB4_TYPE_MAP_NEW.put("1", "未满发车");
    }
    
    static {
    	ALARM_TAB5_TYPE_MAP_NEW.put("3", "站外开门");
    }
    
    static {
    	ALARM_TAB6_TYPE_MAP_NEW.put("4", "迟到告警");
    }
    
    static {
    	ALARM_TAB8_TYPE_MAP_NEW.put("'001'", "油量骤减");
//    	ALARM_TAB8_TYPE_MAP_NEW.put("12", "异常地点加油");
//    	ALARM_TAB8_TYPE_MAP_NEW.put("010", "异常时间加油");
    }
    ...
    static {
    	ALARM_TAB4_TYPE_MAP.put("'1'", "未满发车");
    	ALARM_TAB5_TYPE_MAP.put("'2'", "提前发车");
    	ALARM_TAB6_TYPE_MAP.put("'3'", "站外开门");
    	ALARM_TAB7_TYPE_MAP.put("'4'", "迟到");
    }
    ...
    static {
    	ALARM_DEAL_FLAG_MAP_NEW.put("0", "未处理");
//    	ALARM_DEAL_FLAG_MAP_NEW.put("1", "已处理");
    }
     ...
     * 公告状态map
     */
    public static final Map<String, String> NOTICE_STATE_MAP=new HashMap<String, String>();
    /**
     * 0：未推送 ，1：已推送
     */
    public static final String NOTICE_STATE_KEY_UNPUSH="0";
    public static final String NOTICE_STATE_KEY_PUSH="1";
    static{
    	NOTICE_STATE_MAP.put(NOTICE_STATE_KEY_UNPUSH, "未推送");
    	NOTICE_STATE_MAP.put(NOTICE_STATE_KEY_PUSH, "已推送");
    }
    /**
     * 0：公车私用 ，1：正常使用
     */
    public static final String VECHICLE_ILLEAGAL_USE="0";
    public static final String VECHICLE_NORMAL_USE="1";
    //公告上传图片大小限制
    public static final Long NOTICE_UPLOAD_PIC_SIZE=new Long(200);
    /**早班*/
    public static final String TRIP_PATCH_ROUTE_MORNING="0";
    /**
     * 场内通勤
     */
    public static final String TRIP_PATCH_ROUTE_NORMAL="2";
    /**晚班*/
    public static final String TRIP_PATCH_ROUTE_NIGHT="1";
    /**通勤*/
    public static final String TRIP_PATCH_TYPE_NORMAL="1";
    /**公差*/
    public static final String TRIP_PATCH_TYPE_TALERRANCE="2";
    /**
     * 公告插入图片描述
     */
    public static final String notice_image_desc="公告图片";
    /**
     * 公告图片存储类型 0:文件存储 ，1：数据库存储
     */
    public static final Integer notice_image_storage_file=Integer.valueOf(0);
    public static final Integer notice_image_storage_database=Integer.valueOf(1);
