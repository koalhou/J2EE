/*******************************************************************************
 * @(#)UploadFileInfo.java 2012-5-7
 *
 * Copyright 2012 Neusoft Group Ltd. All rights reserved.
 * Neusoft PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 *******************************************************************************/
package com.neusoft.clw.infomanage.fileupload.domain;

/**
 * @author <a href="mailto:jin.p@neusoft.com">JinPeng </a>
 * @version $Revision 1.1 $ 2012-5-7 上午10:42:38
 */
public class UploadFileInfo {
	...
	public void setSoftware_uri(String software_uri) {
		this.software_uri = software_uri;
	}
