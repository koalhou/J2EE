package com.neusoft.clw.sysmanage.datamanage.vehiclemanage.domain;
...
public class VehcileInfo {
 ...
 // 2013-10-17添加
    ...
    private String organization_id_s;
    ...
    // 照片
    private byte[] veh_photo = null;
    
    // 道路运输证
    private String veh_yunshuid;
    
    // 附加费
    private String veh_fei;
    ...
    private String plan_num;//2013-10-16添加规划人数
    
    private String trip_id;//2013-10-17添加规划id
	...
	public String getOilbox_capacity() {
		return oilbox_capacity;
	}

	public void setOilbox_capacity(String oilbox_capacity) {
		this.oilbox_capacity = oilbox_capacity;
	}
	...
	public String getPhot_name() {
		return phot_name;
	}

	public void setPhot_name(String phot_name) {
	...
	public byte[] getVeh_photo() {
		return veh_photo;
	}

	public void setVeh_photo(byte[] veh_photo) {
		this.veh_photo = veh_photo;
	}

	public String getVeh_yunshuid() {
		return veh_yunshuid;
	}

	public void setVeh_yunshuid(String veh_yunshuid) {
		this.veh_yunshuid = veh_yunshuid;
	}

	public String getVeh_fei() {
		return veh_fei;
	}

	public void setVeh_fei(String veh_fei) {
		this.veh_fei = veh_fei;
	}
	...
	public String getOrganization_id_s() {
		return organization_id_s;
	}

	public void setOrganization_id_s(String organization_id_s) {
		this.organization_id_s = organization_id_s;
	}
