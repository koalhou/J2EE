    ...
    public String userAdd() {
        ...
        try {
            ...
            if (addUserRole(uinfo) == null) {
                ...
                Theme theme = (Theme) service.getObject("themeSet.getThemeSetByUser", uinfo.getCreater());
				if(theme == null) {
					theme = (Theme) service.getObject("themeSet.getThemeSetByUser", "default");
				}
				theme.setId(UUIDGenerator.getUUID32());
				theme.setUserId(uinfo.getUserID());
                service.insert("themeSet.insertThemeDetails", theme);
            }
