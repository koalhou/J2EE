...
public class StudentInfo {
    ...
    private String stu_remark; //2013-10-16添加 学生备注字段
    
    private String relative_tel;//2013-10-23添加电话字段
    
    private String organization_id_s; //添加查询条件
	...
	public String getStandbystuid() {
		return standbystuid;
	}

	public void setStandbystuid(String standbystuid) {
		this.standbystuid = standbystuid;
	}
	...
	public void setRelative_tel(String relative_tel) {
		this.relative_tel = relative_tel;
	}
