 ...
 *******************************************************************************/
package com.yutong.clw.nio.back;
...
public class BackMap extends ConcurrentHashMap<String, Back> {
    ...
    private LinkedList<Back> backlist = new LinkedList<Back>();
    ...
    public synchronized Back getList() {
    	Back back = backlist.poll();
    	backlist.add(back);
		return back;
	}
	
	public LinkedList<Back> getBacklist() {
		return backlist;
	}

	public synchronized void setList(Back back){
		backlist.add(back);
	}

	public void setBacklist(LinkedList<Back> backlist) {
