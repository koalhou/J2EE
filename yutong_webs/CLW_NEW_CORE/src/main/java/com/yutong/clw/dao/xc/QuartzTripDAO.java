...
import com.yutong.clw.beans.xc.StudentTrip;
import com.yutong.clw.beans.xc.Trip;
import com.yutong.clw.quartz.thread.QuartzThread;
...
public class QuartzTripDAO extends AbstractDaoManager {
	...
	String sql = "SELECT CXSS.SITE_ID,CXSS.SITE_NAME,CXSS.SICHEN_ADDR,CXSS.SITE_LONGITUDE,CXSS.SITE_LATITUDE,'' PLAN_IN_TIME,'' PLAN_OUT_TIME,nvl(CXSS.set_in,'100') set_in,nvl(CXSS.set_out,'80') set_out,nvl(CXSS.set_perstation,'1') set_perstation"				
				+ " FROM TQC_TRIP_EXECUTE CXTT,(SELECT CXRS.ROUTE_ID,CXST.SITE_ID,CXST.SITE_NAME,CXST.SICHEN_ADDR,CXST.SITE_LONGITUDE,CXST.SITE_LATITUDE,CXRS.RS_ORDER,CXRS.set_in,CXRS.set_out,CXRS.set_perstation"
