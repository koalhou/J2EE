...
import com.neusoft.tag.communicate.msg.down.ActiveTestResp;
import com.neusoft.tag.communicate.msg.down.BindResp;
import com.yutong.clw.config.ContentParamName;
import com.yutong.clw.dao.impl.ActiveCoreDAO;
import com.yutong.clw.nio.mina.interfaces.AbstractNioHandler;
import com.yutong.clw.nio.mina.interfaces.ActiveTest;
import com.yutong.clw.nio.msg.factory.InsideMsgFactory;
import com.yutong.clw.nio.msg.up.InsideMsg;
import com.yutong.clw.nio.msg.util.InsideMsgStatusCode;
import com.yutong.clw.nio.processor.IInsideProcessor;
import com.yutong.clw.nio.processor.down.BindRespProcessor;
...
//        IInsideProcessor processor = InsideProcessorMap.getInstance().getProcessor(command);
    	IInsideProcessor processor = BindRespProcessor.getInstance();
        if (processor != null) {
            InsideMsg msg = processor.parse(buf);
            processor.valid(msg);
