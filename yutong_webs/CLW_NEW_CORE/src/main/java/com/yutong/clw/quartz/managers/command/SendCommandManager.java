package com.yutong.clw.quartz.managers.command;
...
import com.yutong.clw.beans.app.SendNextHolesReq;
import com.yutong.clw.beans.app.SendReq;
import com.yutong.clw.config.Config;
import com.yutong.clw.config.Constant;
import com.yutong.clw.dao.analysis.SendCommandDAO;
...
import com.yutong.clw.service.OilWearSQL;
	...
	//							back.getCommunicateService().send(bytes);
	     ...
	     try {		
				...
				if (runflag) {
					...
					oilWearSQL.synFromInfoToAlarm(currentDateNoSplit); 
