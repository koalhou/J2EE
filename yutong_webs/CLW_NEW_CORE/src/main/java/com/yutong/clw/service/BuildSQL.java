...
import com.yutong.clw.beans.cl.MsgCfgBean;
import com.yutong.clw.beans.cl.TerminalBean;
import com.yutong.clw.beans.cl.UserBean;
...
import com.yutong.clw.dao.impl.MsgCfgDAO;
...
//				}
	...
	public String buildInsertUp_RealTimeSql(Up_InfoContent urt, String id) {
		...
		sql
				.append("insert into CLW_YW_TERMINAL_RECORD_T (ID, TERMINAL_ID, VEHICLE_VIN, SIM_CARD_NUMBER, "
