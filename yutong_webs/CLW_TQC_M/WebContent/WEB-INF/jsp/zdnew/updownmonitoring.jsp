...
<body>
  ...
  <%@include file="updownmonitoring_validate.jsp"%>
						...
						<table width="100%" border="0" cellspacing="5" cellpadding="0">
								...
								<tr>
									<td class="reportOnline2">
										<s:if test="#session.perUrlList.contains('111_0_5_8_1')">
												...
												<td>
													<table border="0" cellspacing="2" cellpadding="0">
														<tr>
															...
															<td>班车号：<s:textfield id="vehicle_code" name="vehicle_code" cssClass="input120" />
															</td>
															<td>
																日期：															
															</td>
															<td>
															 	<input readonly="readonly" id="start_time" name="start_time"  
																       ...
																       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,isShowToday:false,autoPickDate:true})"/>
										                        <input type="hidden" id="nullEle"/><%-- 至 ,maxDate:'#F{$dp.$D(\'end_time\')}'
															    <input readonly="readonly" size="10" id="end_time" name="end_time"
																       class="Wdate" type="text"  value="<s:property value='end_time' />"
																       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,isShowToday:false,autoPickDate:true,minDate:'#F{$dp.$D(\'start_time\')}'})"/> --%>
															</td>
															<td>
