...
<div id="wrapper">
	...
	<s:form id="feedBackDetail" action="readyPage.shtml" method="post" enctype="multipart/form-data">
		...
		<table id="studentTable" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td valign="top">
				<table class="msgBox2" width="720" height="400" border="0" align="center"
					cellpadding="0" cellspacing="0">
					<tr>
						<td height="16"><span class="msgTitle">问题反馈明细</span></td>
					</tr>
					<tr>
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td colspan="3" rowspan="3">
											<s:textarea id="remarks1" name="feedBackMsg.content" rows="10"  cols="83" ></s:textarea>
									</td>
								</tr>
								<tr>
