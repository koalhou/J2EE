...
<%@page import="com.neusoft.clw.common.util.BytetoImage" %>
<html>
<head>
...
<script type="text/javascript" src="<s:url value='/scripts/jQuery/json.js' />"></script>
...
.navigation{ float: right; padding-top: 0px; margin: 0 0 0 -50; height: 75px; width: 600px;}
.navigation ul{ float: left; height: 86px; margin: 0; width: 581px;}
.navigation li{ float: right; padding: 0; list-style: none;position:relative;}
.navigation a{
	color: #fff;
    display: block;
    margin: 0 2px;
...
<div id="header" style="background: url(showPhoto.shtml?id=<s:property value="theme.id" />&type=headerclass) repeat-x left top; height: 80px;  min-width: 1256px; width:100%;">

<div style="background: url(showPhoto.shtml?id=<s:property value="theme.id" />&type=headbgclass) no-repeat left top; float: left; height: 80px;width:100%;" style="position: relative;">
<div class="logo"><img  style="margin: 2px 0px 0px 0px;" src="showPhoto.shtml?id=<s:property value="theme.id" />&type=companylogo" /></div>
...
<div align="center">
<form id="form" action="imageuploadFile.shtml" method="post" enctype="multipart/form-data">
...
<td><img id="headerimg" src="showPhoto.shtml?id=<s:property value="theme.id" />&type=headerclass"/></td>
<td><a id="headera" href="showPhoto.shtml?id=<s:property value="theme.id" />&type=headerclass">查看</a></td>
...
<td><img style="width:200px;height:80px;" id="headbgimg" src="showPhoto.shtml?id=<s:property value="theme.id" />&type=headbgclass"/></td>
<td><a id="headbga" href="showPhoto.shtml?id=<s:property value="theme.id" />&type=headbgclass">查看</a></td>
...
<td><img id="logoimg" src="showPhoto.shtml?id=<s:property value="theme.id" />&type=companylogo"/></td>
<td><a id="logoa" href="showPhoto.shtml?id=<s:property value="theme.id" />&type=companylogo">查看</a></td>
...
<div align="center">
<form id="form2" action="navigationFile.shtml" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" value="<s:property value="theme.id" />">
<table>
<tr>
<td>车辆监控背景</td>
...
<td><img id="jkimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi1"/></td>
<td><a id="jka" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi1">下载</a></td>
...
<td><img id="jkactiveimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav1focus"/></td>
<td><a id="jkactivea" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav1focus">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>油量监控背景</td>
...
<td><img id="ylimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi2"/></td>
<td><a id="yla" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi2">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>油量监控活动</td>
...
<td><img id="ylactiveimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav2focus"/></td>
<td><a id="ylactivea" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav2focus">下载</a></td>
<td><label>84*80</label></td>
</tr>
...
<td><img id="ddimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi3"/></td>
<td><a id="dda" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi3">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>调度中心活动</td>
...
<td><img id="ddactiveimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav3focus"/></td>
<td><a id="ddactivea" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav3focus">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>统计中心背景</td>
...
<td><img id="tjimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi4"/></td>
<td><a id="tja" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi4">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>统计中心活动</td>
...
<td><img id="tjactiveimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav4focus"/></td>
<td><a id="tjactivea" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav4focus">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>设置中心背景</td>
...
<td><img id="szimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi5"/></td>
<td><a id="sza" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=mi5">下载</a></td>
<td><label>84*80</label></td>
</tr>
<tr>
<td>设置中心活动</td>
...
<td><img id="szactiveimg" src="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav5focus"/></td>
<td><a id="szactivea" href="showPhoto.shtml?id=<s:property value='theme.id' />&type=nav5focus">下载</a></td>
<td><label>84*80</label></td>
</tr>
</table>

<input type="hidden" name="userId" value="<s:property value="theme.userId" />" />
<input value="上传" type="button" class="button_tab" onclick="navcheck()" />
</form>

</div>

<div align="center">
<form id="form3" action="mapGroundUpdate.shtml" method="post">
<input type="hidden" name="id" value="<s:property value="theme.id" />">
...
jQuery(function() {
	...
	/* if(headerimg.indexOf(fileSplit)>0)
		...
		split="\\"; */
	//$("#show").html(($("#header").css("background")));
	...
	/* for (var key in navphotos_v){
	   alert(key);
	   alert(navphotos_v[key]);
	}
	...
	jQuery.each(jQuery(".navigation ul li"),function(i){
		jQuery(this).children("a").click(function(){
			...
			//navphotos_v["nav"+id_v.substring(id_v.length-1,id_v.length)+"focus"]
			$(this).attr("style","background: url(showPhoto.shtml?id=<s:property value='theme.id' />&type=nav"+id_v.substring(id_v.length-1,id_v.length)+"focus) no-repeat center top;");
		});
	});
