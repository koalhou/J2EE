      ...
      <tr>
        <td class="btnBar"> 
          ...
          <s:if test="\"2\"==userDetail.validFlag">
            <s:if test="#session.perUrlList.contains('111_0_1_3_6')">
          ...
          <s:else>
            <s:if test="#session.perUrlList.contains('111_0_1_3_7')">
          ...
          <s:if test="#session.perUrlList.contains('111_0_1_3_4')">
          ...
          <s:if test="#session.perUrlList.contains('111_0_1_3_3')">
