...
<base target='_self'>
<title><s:property value="getText('user.popup.menu')" /></title>
</head>
<body>
<%@include file="userCheckBoxBrowse_validate.jsp"%>
  <s:form id="userbrowse_form" action="queryUser" method="post" onsubmit="return false;">
                    ...
                    <table border="0" cellspacing="4" cellpadding="0">
                      <tr>
                        <td>
                          ...
                          <s:select name="sysId" list="subSysMap" >
                          </s:select>
                        </td>
                        <td>
                        ...
                        <td><a href="#" onclick="save()" class="sbutton"><s:text name="user.popup.choose" /></a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="30%" class="titleStyleZi">
                                <s:property value="getText('user.popup.info')" />
                              </td>
                            ...
                            <table width="100%" cellspacing="0" class="reportInline2" >
                              ...
                              <tbody style="overflow:auto;">
                                <s:iterator value="userList" status="rowstatus">
                                  <tr>
                                  	<td>
                                  		<s:hidden id="userIdStr" value=""/>
			                       		<s:checkbox name="carChoice" onclick="getCheckValue('%{userId}','%{#rowstatus.index}');" fieldValue="%{loginName}" ></s:checkbox>
		                        	</td>
                                    <td>
