...
<body>
<%@include file="engineTypeCreate_validate.jsp"%>
<s:form id="engineTypeCreate_form" action="createEngineType" method="post">
		...
		<tr>
			...
			<table class="msgBoxPass" border="0" align="center" cellpadding="0"	cellspacing="0">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="32" align="left">
								<span class="msgTitlePwd">发动机型号信息</span>
							</td>
						</tr>
					</table>
					</td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					    <tr>
			              <td width="30%" height="28" align="right">发动机品牌：
			              </td>
