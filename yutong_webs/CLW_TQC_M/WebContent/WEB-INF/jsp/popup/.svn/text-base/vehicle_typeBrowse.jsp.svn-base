...
<body>
  <%@include file="vehicle_typeBrowse_validate.jsp"%>
  
  <s:form id="vehiclebrowse_form" action="query_vehicle_type" method="post" onsubmit="return false;">
                ...
                <tr>
                  <td>
                    <table border="0" cellspacing="4" cellpadding="0">
                      <tr>
                        <td>
                          <s:property value="getText('carbase.info.vehicle_type_id')" />：
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="30%" class="titleStyleZi">
                                <s:property value="getText('carbase.popup.info')" />
                              </td>
                              <td width="69%"align="right">
                                <div class="buhuanhangbut">
                                  <a href="javascript:createVehicleType();" class="btnAdd" title="<s:property value="getText('msg.add')" />">
                                  </a>
                                </div>
                              </td>
                              <td width="1%">&nbsp;</td>
                          ...
                          <div id="list">
                            ...
                            <table width="100%" cellspacing="0" class="reportInline2" >
                              ...
                              <tbody style="overflow:auto;">
                                <s:iterator value="vehicleTypeList" status="rowstatus">
                                  <tr>
                                    <td>
