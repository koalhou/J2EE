...
<body>
  <%@include file="enterpriseBrowseAndCreate_validate.jsp"%>
 
  <s:form id="enterprisebrowse_form" action="queryEnterpriseViewAndCreate" method="post" onsubmit="return false;">
  <s:hidden id="flag" name="flag" />
   
  <table height="668px" width="660px" border="0" cellspacing="0" cellpadding="0" align="center" />
    <tr>
      <td valign="top">
                    ...
                    <table border="0" cellspacing="4" cellpadding="0">
                      <tr>
                        <td>
                          ...
                          <s:textfield id="enterpriseName" name="enterpriseNameQuery" cssClass="input120"/>&nbsp;&nbsp;
                        </td>
                        <td>企业编码：
                          <s:textfield id="enterpriseCode" name="enterpriseCodeQuery" cssClass="input120"/>
                        </td>
                        <td>
                            ...
                            <tr>
                              ...
                              <td width="69%"align="right">
                                <div class="buhuanhangbut">
                                  <a href="javascript:createEnterprise();" class="btnAdd" title="<s:property value="getText('msg.add')" />">
                                  </a>
                                </div>
                              </td>
                              <td width="1%">&nbsp;</td>
