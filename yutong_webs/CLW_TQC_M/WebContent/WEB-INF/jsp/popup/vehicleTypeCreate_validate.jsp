...
<script type="text/javascript">
    ...
    function checkCodeIdUnique(){
	  ...
	  var ret = false; 
	  BaseInfoManageDwr.checkCodeIdUnique(codeObj.value, 'VEHICLETYPE', callBackFun);
	...
	function createEnterprise(){
		...
		if(f1 && f2 && f3 && f4) {
			jQuery.ajax({
				type: 'POST', 
				url: "<s:url value='/popup/createVehicleType.shtml' />",	
				data: {
				...
				success: function(data) {
					if(data=="success"){
						var obj = $('successLbl');
						obj.innerHTML = "车型创建成功！";
						parent.window.submit();
						art.dialog.close();
					}
					if(data == "error") {
						var obj = $('errorLbl');
						obj.innerHTML = "车型创建失败！";
						return false;
					}
				}  
			});
