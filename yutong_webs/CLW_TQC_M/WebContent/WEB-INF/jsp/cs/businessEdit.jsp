...
<body>
  ...
  <%@include file="businessEdit_validate.jsp"%>
  <s:form id="businessEdit_form" action="updateBusiness" method="post">
  
    <s:hidden id="page" name="page" />
    <s:hidden id="pageSize" name="pageSize" />
    <s:hidden id="businessId" name="businessId" />
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td align="center">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td align="left">
                <s:textfield id="email" name="businessInfo.email" maxlength="60" maxlength="60" cssStyle="ime-mode:disabled"/>
              </td>
              <td>&nbsp;</td>
              <td align="right">
      ...
      <tr>
        <td class="btnBar"> 
          ...
          <s:if test="#session.perUrlList.contains('111_0_4_1_4')">
          <s:url id="delBusiness" action="deleteBusiness">
            <s:param name="businessId">${businessId}</s:param>
            <s:param name="page">${page}</s:param>
            <s:param name="pageSize">${pageSize}</s:param>
          </s:url>
          <a href="#" class="buttontwo" onclick="delBusiness('${delBusiness}');">
            <s:property value="getText('btn.delete')" />
          </a>
          </s:if>
          
          <s:if test="#session.perUrlList.contains('111_0_4_1_3')">
