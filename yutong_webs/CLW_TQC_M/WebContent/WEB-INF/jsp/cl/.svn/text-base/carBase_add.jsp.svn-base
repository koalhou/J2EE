	...
	<tr>
		...
		<s:form id="clwForm" name="clwForm"
			...
			<table class="msgBox2" width="650" border="0" align="center"
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
			            ...
			            <tr>
			              ...
			              <td width="25%" align="left">
			                <s:textfield id="limite_number" name="carBaseInfo.limite_number" maxlength="3"/>
			              </td>
			              <td>&nbsp;</td>
			            </tr>
			            <tr>
			            ...
			            <tr>
			              ...
			              <td width="25%" align="left">
			                  <s:textfield id="vehicle_ln" name="carBaseInfo.vehicle_ln" maxlength="7"/>
			              </td>
			              <td>&nbsp;</td>
			            ...
			            <tr>
							<td height="32" class="msgtr" colspan="6" align="left">
							  <span class="msgTitle">&nbsp;&nbsp;<s:property value="getText('carbase.info.engine')"/>
							  (<span class="noticeMsg">*</span><s:property value="getText('input.required')"/>)  
							  </span></td>
						</tr>
						<tr>
			              ...
			              <td width="25%" align="left">
			                  <s:textfield id="standard_rotate" name="carBaseInfo.standard_rotate" value="1500" maxlength="30"/>
			              </td>
			              <td>&nbsp;</td>
			            </tr>
						<tr>
				...
				<tr>
					<td class="btnBar"><a href="<s:url value='/cl/carbase.shtml' />" class="buttontwo"><s:property value="getText('btn.back')"/></a> 
