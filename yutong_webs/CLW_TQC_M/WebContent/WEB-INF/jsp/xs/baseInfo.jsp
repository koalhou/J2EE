...
<body>
  ...
  <%@include file="baseInfo_validate.jsp"%>
  <s:form id="baseinfo_form" action="addBaseInfo" method="post">
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="btnBar"> 
          <s:url id="cancelAdd" action="baseinfomanage">
          ...
          <a href="#" class="buttontwo" onclick="goBack('${cancelAdd}')">
