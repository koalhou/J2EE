...
function searchChartData()
{
	...
	var url='<s:url value="/ubs/browserList.shtml" />'+'?searchparam.startDate='+startDate+'&searchparam.endDate='+endDate;
	jQuery.ajax({
		url : url,
		cache : false,
		dataType : "json",
...
function loadChart(data)
{
	...
	if(indicators.length>1)
	{
		...
		strbarms.push("<chart caption='' xAxisName='浏览器' yAxisName='次数' >");
	...
	{
		var sbar=[];
		sbar.push("<chart caption='浏览器'  xAxisName='浏览器' rotateYAxisName='0' yAxisName='次数' >");
		var offset=0;
		var indcttext="";
...
jQuery(function() {
	...
	roleList.flexigrid({
		...
		url: '<s:url value="/ubs/browserPageList.shtml" />',
		dataType: 'json',
		height: 'auto',
		width: 'auto',
		colModel : [
		    		{display: '<s:text name="ub.system.browser" />', name : 'systemname', width : '200', sortable : true, align: 'left'},
		...
		<tr valign="top">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<span style="float: left; padding: 0px 10px; font-weight: bold;">
						<s:property value="getText('ub.system.statduration')" />：</span>
						<ul class="recent_ul">
							<li id="recent7"><a href="#" id="q_r7" onclick="q_switch(7)">
							<s:property value="getText('ub.recent7day')" /></a></li>

							<a href="#" id="q_r30" onclick="q_switch(30)"> <s:property
						...
						<div style="float: left; padding: 0px 10px;">&nbsp; <s:textfield
				...
				<tr>
					...
					<div
						style="margin: 10px;  min-height: 600px; background-color: white;">
					<div class="ubtab">
					<ul>
						<li><a href="#"
							onclick="tabClick('<s:url value='/ub/system/ubsolution.shtml'/>')">
						<s:property value="getText('ub.system.solution')" /> </a></li>
						<li><a href="#"
							onclick="tabClick('<s:url value='/ub/system/ubos.shtml'/>')">
						<s:property value="getText('ub.system.os')" /> </a></li>
						<li class="ubtabselect"><a href="#"> <s:property
							value="getText('ub.system.browser')" /> </a></li>
						<li><a href="#"
							onclick="tabClick('<s:url value='/ub/system/ubflash.shtml'/>')">
						<s:property value="getText('ub.system.flash')" /> </a></li>
						<li><a href="#"
							onclick="tabClick('<s:url value='/ub/system/ubzone.shtml'/>')">
						<s:property value="getText('ub.system.zone')" /> </a></li>
					</ul>
					<div class="ubtabcontent">
					<div style="margin: 5px"><!-- tab内容 -->

					<div id="n_indicator"
						style="height: 30px; width: 100%; margin: 10px 10px 10px 10px;">
					<s:property value="getText('ub.system.indicator')" />: <span
						class="n_indicator_cbx"> <label for="check_vcnt"
						style="margin-left: 3px; vertical-align: middle;"><input
						type="checkbox" id="check_vcnt" style="vertical-align: middle;"
						onclick="indicatorClick(this)" checked="checked" value="vcnt" /><s:property
						value="getText('ub.system.vcnt')" /></label> </span> <span
						class="n_indicator_cbx"> <label for="check_ventcnt"
						style="margin-left: 3px; vertical-align: middle;"><input
						type="checkbox" id="check_ventcnt" style="vertical-align: middle;"
						onclick="indicatorClick(this)" checked="checked" value="ventcnt" /><s:property
						value="getText('ub.system.ventcnt')" /></label> </span> <span
						class="n_indicator_cbx"> <label for="check_vacountcnt"
						style="margin-left: 3px; vertical-align: middle;"><input
						type="checkbox" id="check_vacountcnt"
						style="vertical-align: middle;" onclick="indicatorClick(this)"
						checked="checked" value="vactcnt" /><s:property
						value="getText('ub.system.vamaountcnt')" /></label> </span></div>
