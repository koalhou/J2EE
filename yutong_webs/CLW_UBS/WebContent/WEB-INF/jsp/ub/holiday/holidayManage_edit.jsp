...
<%@include file="holidayManage_edit_validate.jsp"%>

<s:form id="holidayinfo_form" action="holidaymanage_do_edit"
	method="post">
	<s:hidden id="page" name="page" />
	<s:hidden id="pageSize" name="pageSize" />
	<s:hidden id="groupname" name="groupname"/>
	<s:hidden id="dayflag" name="staitcsObject.dayflag" value="0" />
			...
			<table class="msgBox2" width="650" border="0" align="center"
				...
				<tr>
					<td height="32"
						...
						value="getText('ub.holiday.holidayinfo')" /> (<span
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="20%" height="28" align="right"><s:property
								value="getText('ub.holiday.holidayname')" />：</td>
							<td width="100%" class="fsBlack" align="left"><s:textfield
								id="holidayname" name="staitcsObject.day_name" maxlength="60" /><span
								class="noticeMsg">*</span></td>
						</tr>
						<tr>
							<td width="20%" height="28" align="right"><s:property
								value="getText('ub.holiday.duration')" />：</td>
							<td width="100%" class="fsBlack" align="left"><s:textfield
								...
								cssClass="Wdate">
							</s:textfield><span class="noticeMsg">*</span></td>
						</tr>
				...
				<tr>
					<td class="btnBar"><a href="#" class="buttontwo"
						onclick="goBack('holidaymanage.shtml')"> <s:property
						value="getText('btn.back')" /> </a> 
						
						
						
						
						<s:if test="#session.perUrlList.contains('111_4_8_3_1_4')">
				          <s:url id="delholiday" action="holidaymanage_do_del">
				          ...
				          <a href="#" class="buttontwo" onclick="del('${delholiday}');">
				            <s:property value="getText('btn.delete')" />
				          </a>
				          </s:if>
          
          				<s:if test="#session.perUrlList.contains('111_4_8_3_1_3')">
						<a href="#" class="buttontwo" onclick="submitForm()"> <s:property
