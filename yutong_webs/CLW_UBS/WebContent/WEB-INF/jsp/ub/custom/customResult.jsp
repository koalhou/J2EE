...
<%@include file="customResult_js.jsp"%>
	 ...
	 &nbsp;
					...
					<tr>
						<td class="reportOnline2" style="background:rgb(246,246,246);" >
							<div style=" float:right;padding: 5px; margin:5px;line-height: 30px;">
		                              	 ...
		                              	 onkeyup="e = event ? event :(window.event ? window.event : null); if(e.keyCode==13)query();"/>
		                              	 <div style="float:left;height:25px;margin-top:3px;margin-left:3px;"><div class="ub_searchbtn"  onclick="query()"></div></div>
                            </div>
				...
				<tr style="background:white;">
					...
					<div style="margin:5px;border:1px solid #cccccc;">
							<div style="height:30px;background:#eeeeee;border-bottom:1px solid #cccccc;margin-bottom:5px;line-height:30px;font-weight:bold;padding-left:10px;">企业客户访问统计</div>		
