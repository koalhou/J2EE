	...
	<tr>
		...
		<s:form id="maintenanceForm" name="maintenanceForm"
			...
			<table class="msgBox2" width="650" border="0" align="center"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td class="msgtr" width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.service.item')"/></td>
			              	...
			              	<td class="msgtr">&nbsp;<INPUT type="hidden" name="maintenance.item_id" value="<s:property value='#request.itemIds[0]'/>"/></td>
			            </tr>
						<tr>
						...
						<tr>
							<td class="msgtr" width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.service.item')"/></td>
			              	...
			              	<td class="msgtr">&nbsp;<INPUT type="hidden" name="maintenance.item_id" value="<s:property value='#request.itemIds[1]'/>"/></td>
			            </tr>
						<tr>
							<td width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.condition')"/>：</td>
			              	<td width="30%" class="fsBlack" align="left">
						...
						<tr>
							<td class="msgtr" width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.service.item')"/></td>
			              	...
			              	<td class="msgtr">&nbsp;<INPUT type="hidden" name="maintenance.item_id" value="<s:property value='#request.itemIds[2]'/>"/></td>
			            </tr>
						<tr>
							<td width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.condition')"/>：</td>
			              	<td width="30%" class="fsBlack" align="left">
						...
						<tr>
							<td class="msgtr" width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.service.item')"/></td>
			              	...
			              	<td class="msgtr">&nbsp;<INPUT type="hidden" name="maintenance.item_id" value="<s:property value='#request.itemIds[3]'/>"/></td>
			            </tr>
						<tr>
							<td width="20%" height="28" align="left">&nbsp;&nbsp;<s:property value="getText('service.management.maintenance.condition')"/>：</td>
			              	<td width="30%" class="fsBlack" align="left">
				...
				<tr>
					<td class="btnBar"><!-- <a href="<s:url value='/sm/maintenanceToMod.shtml' />" class="buttontwo"><s:property value="getText('btn.back')"/></a> -->
