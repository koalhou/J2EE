...
<body>
  ...
  <%@include file="poiImport_validate.jsp"%>
  <s:form id="poiimport_form" action="importPoi" method="post" enctype="multipart/form-data">
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="32" background="<s:url value='/images/msg_title_bg.gif'/>" align="left">
          <span class="msgTitle">&nbsp;&nbsp;
            <s:property value="getText('poi.import')" />
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="fsBlack" align="left">
                ...
                <a href="<s:url value='/template/PoiInformation.xls' />"><s:property value="getText('file.template.download')" /></a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td align="center">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="40" align="right" width="14%">
                <b>
