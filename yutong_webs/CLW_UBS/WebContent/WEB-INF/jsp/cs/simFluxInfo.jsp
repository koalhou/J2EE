...
<head>
<title>
  <s:property value="getText('menu.xj')" />&nbsp;|&nbsp;<s:property value="getText('sim.flux.manage')" />
</title>
...
<body>
  ...
  <%@include file="simFluxInfo_validate.jsp"%>
  <s:form id="simfluxinfo_form" action="addSimFlux" method="post">
