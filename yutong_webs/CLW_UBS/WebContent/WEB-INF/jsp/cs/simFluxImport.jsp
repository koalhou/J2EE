...
<body>
  ...
  <%@include file="simFluxImport_validate.jsp"%>
  <s:form id="simfluximport_form" action="importSimFlux" method="post" enctype="multipart/form-data">
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="32" background="<s:url value='/images/msg_title_bg.gif'/>" align="left">
          <span class="msgTitle">&nbsp;&nbsp;
            <s:property value="getText('simflux.manage.import')" />
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td class="fsBlack" align="left">
                ...
                <a href="<s:url value='/template/SimFluxInformation.xls' />"><s:property value="getText('file.template.download')" /></a>
              </td>
            </tr>
            <tr>
