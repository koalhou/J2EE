...
<body>
  ...
  <%@include file="handheldDeviceInfo_validate.jsp"%>
  <s:form id="handhelddeviceinfo_form" action="addHandheldDevice" method="post">
        ...
        <td align="center">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="20%" class="fsBlack" align="left">
                <s:textfield id="cellPhoneImei" name="handheldDeviceInfo.cellPhoneImei" maxlength="20" cssStyle="ime-mode:disabled"/>
              </td>
            </tr>
            <tr>
              <td width="14%" height="28" align="right">设备编号：</td>
              <td width="20%" class="fsBlack" align="left">
                <s:textfield id="handheldDeviceNo" name="handheldDeviceInfo.handheldDeviceNo" maxlength="10" cssStyle="ime-mode:disabled"/>
              </td>
            </tr>
            <tr>
              <td width="14%" height="28" align="right">手机号：</td>
              <td width="20%" class="fsBlack" align="left">
                <s:textfield id="cellPhone" name="handheldDeviceInfo.cellPhone" maxlength="20" cssStyle="ime-mode:disabled"/>
              </td>
            </tr>
          </table>
        </td>
