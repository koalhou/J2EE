...
/**
* <p>Title: Scalper Program</p>
* <p>Description: </p>
* <p>Copyright: Copyright (c) 2004</p>
* <p>Company: Neusoft MID</p>
...
public class StringUtils
{
 ...
 public static String addPostposition(String sSource,String sAdd,int iDigital)
  {
     String sTemp = sSource.trim();
     for(int i = 1 ; i <= iDigital-sTemp.trim().length() ; i++)
     {
...
public static String getFormatString(String sSource)
  {
	...
	public static String trim(String msid, int msisdnMaxLength) {
		return (msid != null && msid.length() > msisdnMaxLength) ? msid.substring(0, msisdnMaxLength) : msid;
	}
}
