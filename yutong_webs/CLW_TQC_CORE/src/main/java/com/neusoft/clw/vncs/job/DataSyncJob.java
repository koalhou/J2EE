package com.neusoft.clw.vncs.job;
...
import com.neusoft.SchoolBus.vncs.manage.QuartzTripManager;
...
import com.neusoft.clw.vncs.cachemanager.FullQuantityCacheManager;
...
import com.neusoft.clw.vncs.manage.ReportManager;
import com.neusoft.clw.vncs.manage.SendCommandManager;
import com.neusoft.clw.vncs.util.StringUtil;
import com.neusoft.parents.cachemanager.PreLineAlarm;
...
import com.neusoft.parents.newsmanager.NewsManager;
import com.neusoft.parents.overpreline.manager.OverPreLine;
import com.neusoft.privateuse.manager.PrivateUseManager;
import com.neusoft.smsplatform.message.manage.SyncManager;
import com.neusoft.tqcpt.manage.TqcOilWearManager;
import com.neusoft.tqcpt.manage.TqcStatisticManager;
...
public class DataSyncJob {
	...
	private PreLineAlarm preLineAlarm;
	
//	private OverPreLine overPreLine;
//
	private PrivateUseManager privateUseManager;
	...
	public void sendCommandInit() {
		...
		sendCommandManager.init(0,1);//查询当天的
	}
	
	
	/**
	 * add by liuja
	 * 每天2点同步30天的加油和偷油记录，主要是针对补传的数据
	 */
	public void sendCommandInitByOneDay() {
		MDC.put("session", "[" + StringUtil.getLogRadomStr() + "]");
		MDC.put("modulename", "[sendCommandInitByOneDay]");
		sendCommandManager.init(30,0);//查询30天之前的到昨天的
	}
	 ...
	 * 每日凌晨更新车辆预运行轨迹 
	 */
    public void updatePreLineInit()
    {
        MDC.put("session", "[" + StringUtil.getLogRadomStr() + "]");
        MDC.put("modulename", "[updatePreLineInit]");
        preLineAlarm.init();
    }
	 ...
	 * 车辆偏航 
	 */
//    public void overPreLineInit()
//    {
//        MDC.put("session", "[" + StringUtil.getLogRadomStr() + "]");
//        MDC.put("modulename", "[overPreLineInit]");
//        overPreLine.init();
//    }
    
    //公车私用
	public void privateUseInit() {
		MDC.put("session", "[" + StringUtil.getLogRadomStr() + "]");
		MDC.put("modulename", "[privateUseInit]");
		privateUseManager.init();
	}
...
//		}
	...
	public PreLineAlarm getPreLineAlarm() {
		return preLineAlarm;
	}

	public void setPreLineAlarm(PreLineAlarm preLineAlarm) {
		this.preLineAlarm = preLineAlarm;
	}

//	public OverPreLine getOverPreLine() {
//		return overPreLine;
//	}
//
//	public void setOverPreLine(OverPreLine overPreLine) {
//		this.overPreLine = overPreLine;
//	}
//
	public PrivateUseManager getPrivateUseManager() {
		return privateUseManager;
	}

	public void setPrivateUseManager(PrivateUseManager privateUseManager) {
		this.privateUseManager = privateUseManager;
	}
