 ...
 *******************************************************************************/
package com.neusoft.clw.nio.client;
...
public abstract class AbstractNioHandler<E extends ICommunicateService> implements INioHandler<E> {
    ...
    private ThreadPoolExecutor threadPool = new ThreadPoolExecutor(Integer.parseInt(Config.props
            .getProperty("corePoolSize")), Integer
            .parseInt(Config.props.getProperty("maxPoolSize")), Long.parseLong(Config.props
            .getProperty("keepAliveTime")), TimeUnit.SECONDS, new ArrayBlockingQueue(Integer
            .parseInt(Config.props.getProperty("queueSize"))), new RejectedExecutionHandler() {
