...
public class Up_PhotoContent extends UpLoadDataReq{
	...
	public void setPhoto_time(String photoTime) {
		photo_time = photoTime;
	}
	public String getChannel_number() {
		return channel_number;
	}
	public void setChannel_number(String channelNumber) {
		channel_number = channelNumber;
	}
	public String getPhoto_file() {
		return photo_file;
	}
	public void setPhoto_file(String photoFile) {
