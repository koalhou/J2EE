...
function treeCheckBox(obj) {
	...
	if (obj.checked) {
		...
		var objid=obj.attributes.getNamedItem('module_id').value;
		if(objid=="111_3_1_12_5"||objid=="111_3_1_12_6"||objid=="111_3_1_12_7"||objid=="111_3_1_12_8"){
			//alert(obj.attributes.getNamedItem('module_id').value);
			document.getElementById('tree_box_id_111_3_1_12_1').checked = true;
		}else{
			//document.getElementById('tree_box_id_111_3_1_12_1').checked = true;
		}
		...
		if(document.getElementById('tree_box_id_111_3_1_12_5').checked||document.getElementById('tree_box_id_111_3_1_12_6').checked||document.getElementById('tree_box_id_111_3_1_12_7').checked||document.getElementById('tree_box_id_111_3_1_12_8').checked){
			document.getElementById('tree_box_id_111_3_1_12_1').checked = true;
		}
