...
<div class="login_c">
    	...
    	<table cellpadding="0" cellspacing="0" class="login_table">
            ...
            <tr>
            	<td class="login_txt"></td>
                <td><a id="loginbtn" href="#" onClick="submitForm()" class="login_txt"><img src="newimages/login_btn.gif" /></a>
                    <a id="ff" href="http://test.axxc.cn:8082/CLW_XCP_SHOW/autoLogin.jsp" target="_blank" class="show_btn"><img src="newimages/show_btn.gif" /></a></td>
            </tr>
        </table>
    ...
    <p>客服电话：400-659-6666 豫ICP备10203497号-3 版权所有&copy;宇通集团2010-2015</p><br/>
    	建议使用IE8，1440*900分辨率
    </div>
