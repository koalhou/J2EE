package com.neusoft.clw.sysmanage.datamanage.rolemanage.service;
...
public class RoleManageServiceImpl extends ServiceImpl implements
    ...
    public void insertRolesStr(String role_name, String remark, String userID,
        ...
        try {
            ...
            // roleManageDao.insertRoles("Role.saveRoleRight", rolestr
            // .split(","), roleID,enterid);
