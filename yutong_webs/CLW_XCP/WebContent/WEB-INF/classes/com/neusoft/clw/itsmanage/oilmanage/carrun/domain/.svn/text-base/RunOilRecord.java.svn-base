package com.neusoft.clw.itsmanage.oilmanage.carrun.domain;

public class RunOilRecord {
    private String ID;
    ...
    private String str_vins;
    
    private String queryTime;
    
    private String route_ids;
    
    private String HAVEMILEAGE ;
    ...
    public String getHAVEMILEAGE() {
		return HAVEMILEAGE;
	}

	public void setHAVEMILEAGE(String havemileage) {
		HAVEMILEAGE = havemileage;
	}
    ...
    public void setSpd_oil(String spd_oil) {
        this.spd_oil = spd_oil;
    }
    ...
    public String getStr_vins() {
        return str_vins;
    }

    public void setStr_vins(String str_vins) {
        this.str_vins = str_vins;
    }
