...
public interface Service {
    ...
    // 批处理修改考核油耗设置
    void batchCanelCars(List < VehcileInfo > obj) throws SQLException;
    ...
    //批处理定时拍照设置
    void addBatchPhotoSet(List <PhotoGraphSet> obj) throws SQLException ;
    
    void addBatchEnergySmsSet(List <EnergySms> smsList) throws SQLException ;
}
