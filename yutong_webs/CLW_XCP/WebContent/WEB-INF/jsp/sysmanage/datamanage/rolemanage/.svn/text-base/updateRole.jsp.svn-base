...
<div id="wrapper">						
	...
	<div id="content">					
			...
			<s:form id="updateRoleform" action="updateRoleAction.shtml"	method="post" onsubmit="return false;">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<table class="msgBox2" width="650" border="0" align="center"
								...
								<tr>
									...
									<table border="0" cellpadding="0" cellspacing="8" >
										...
										<div class="btnBar">
										    <a
												href="#" onclick="goBack('roleAction.shtml')" class="buttontwo">取消</a>
										    <s:if test="#session.perUrlList.contains('111_3_5_1_3')">
						...
						<s:text name="button.delete" /></a>
											...
											<s:if test="#session.perUrlList.contains('111_3_5_1_2')">
