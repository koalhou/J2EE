	        ...
	        <td valign="top" >
	          <div class="toolbar">
			      ...
			      <tr>
			        ...
			        <td>
			          <a href="<s:url value='/zdnew/simpleInit.shtml' />" class="buttontwo">关键参数</a>
			        </td>
			        <td>
					        ...
					        <tr>
					          ...
					          <td width="85%" align="left">
					            <table border="0" cellspacing="5px" cellpadding="0px">
					          	  ...
					          	  <tr>
					          	    <td valign="top" colspan="5">定时时间(min)：<s:textfield id="regularTime" name="xcTerminalParamsSet.regularTime" maxlength="5" cssStyle="ime-mode:disabled"/>(>=5)</td>
					          	  </tr>
					          	</table>
					          </td>
					        </tr>
