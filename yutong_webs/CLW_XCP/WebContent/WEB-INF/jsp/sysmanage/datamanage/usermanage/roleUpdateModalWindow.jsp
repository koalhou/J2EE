                  ...
                  <div class="msgCententtanchu">
                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                      <tr>
						...
						<td>
						<s:select id="selectRightos" name="selectRightos" list="roleInitMap" size="10" multiple="true" cssStyle="width: 200px;" ondblclick="javascript:deleteSelect(document.getElementById('selectLeftos'), document.getElementById('selectRightos'),'os');" />
