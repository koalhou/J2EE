...
<table id="contenttable" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td valign="top">
		...
		<s:form id="clwForm" name="clwForm"
			action="entimanage_goto_add.shtml" method="post">
				...
				<table width="600" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <td colspan="5" align="left" valign="top"><label> <textarea
							...
							readonly="readonly" style="font-family:'Microsoft Yahei', 微软雅黑, 宋体,Tahoma, Arial, Verdana;"></textarea></label>
					  </td>
					</tr>
				</table>
				</td>
