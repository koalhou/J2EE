	    ...
	    <div id="content">
         <s:form id="message_form" action="messageSendList" method="post">
					...
					<td valign="top" id="rightdiv">
					 <div id="content_rightside">
                        ...
                        <div id="statusManger">
                            <div class="car-info">
                              <h1 id="carln">未选车</h1>
                              <span id="messagetime" class="times" style="display: none"><s:property value="year"/>-00-00 00:00:00</span>
                             </div>
                              <div class="car-status">
              	                  <table width="700" border="0" cellpadding="0" cellspacing="0">
                	                <tr>
                    	               <th align="left" width="50">状&nbsp;&nbsp;&nbsp;态：</th>
                                       <td width="140"><input id="zhuangtai" type="text" style="background:url(../newimages/text_bg_140.png) no-repeat left top; border:none; width:140px; height:22px; text-indent:5px; padding-right:0px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                       <th align="right" width="100">发送人：</th>
                                       <td width="140"><input id="user" type="text" style="background:url(../newimages/text_bg_140.png) no-repeat left top; border:none; width:140px; height:22px; text-indent:5px; padding-right:0px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                    ...
                                    <tr>
                                       <th align="left" width="50">内&nbsp;&nbsp;&nbsp;容：</th>
                                         <td align="left" id="neirong" colspan="5"></td>
                                     </tr>
                                 </table>
                             </div>
                             <div class="list-area">
                                       ...
                                       <th align="right">时 &nbsp;&nbsp;段：</th>
                                         <td  align="left" style="padding: 0 5px;">
										   ...
										   <input readonly="readonly" id="end_time" name="end_time" value="${end_time}"
																class="Wdate" type="text" 
																style="width:100px;"
																onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true,minDate:'#F{$dp.$D(\'start_time\')}',maxDate:'%y-%M-%d',isShowClear:false})" style="width: 90px"/>                                         
                                         </td>
                                         <td>&nbsp;&nbsp;</td>
          ...
          <s:form id="export_form" action="" method="post">
			...
			<s:hidden id="exportObj.sms_type" name="exportObj.sms_type"/>
			<s:hidden id="exportObj.start_time" name="exportObj.start_time"/>
			<s:hidden id="exportObj.end_time" name="exportObj.end_time"/>
			<s:hidden id="exportObj.chooseorgid" name="exportObj.chooseorgid"/>
		</s:form>
     </div>
