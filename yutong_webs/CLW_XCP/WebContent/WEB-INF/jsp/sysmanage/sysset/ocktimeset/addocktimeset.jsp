...
<div id="wrapper">
  ...
  <s:form id="add_ocktimesetform" action="TimeSet_add" method="post">
  <s:hidden name="page" />
  <s:hidden name="pageSize" />
  <input type="hidden" id="enid"
				name="enid" value="<s:property value="#session.adminProfile.entiID" />">
			    ...
			    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
			      <tr>
			        <td height="32" background="<s:url value='/images/msg_title_bg.gif'/>">
			          <span class="msgTitle">&nbsp;&nbsp;<s:text name="ocktime.create" /></span>
			        </td>
			      </tr>
			      <tr>
			        <td align="center">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			            <tr>
			             ...
			             <tr>
			             <td width="14%" height="28" align="right">开始时间:</td>
			              <td width="36%" align="left">
			                  <input readonly="readonly" id="start_time" name="ocktimeset.start_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true,maxDate:'#F{$dp.$D(\'end_time\')}',minDate:'#F{$dp.$D(\'end_time\',{d:-40})}'})" cssClass="Wdate">
							</input><span class="noticeMsg">*</span>
						</td>
			              <td width="14%" height="28" align="right">结束时间:</td>
			              <td width="36%" align="left">
			                  <input readonly="readonly" id="end_time" name="ocktimeset.end_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true,maxDate:'#F{$dp.$D(\'start_time\',{d:40})}',minDate:'#F{$dp.$D(\'start_time\')}'})" cssClass="Wdate">
							</input><span class="noticeMsg">*</span>
						</td>
			            </tr>
...
<%@include file="addocktimeset_js.jsp"%>
</body>
</html>