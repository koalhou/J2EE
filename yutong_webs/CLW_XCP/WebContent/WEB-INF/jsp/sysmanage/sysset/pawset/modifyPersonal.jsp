		  ...
		  <td valign="top" >
	          ...
	          <table class="msgBox2" width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      ...
	                      <tr>
	                        <td height="220">
	                          <table width="690" border="0" cellspacing="5" cellpadding="0">
	                            <tr>
	                            ...
	                            <tr>
	                              ...
	                              <td width="36%" class="fsBlack">
	                              <s:textfield id="birth" name="userinfo.userBirth" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true,maxDate:'%y-%M-%d'})" cssClass="Wdate"></s:textfield></td>
	                            ...
	                            <td width="14%" height="28" align="right">性别：</td>
	                              ...
	                              <td width="36%" class="fsBlack">
	                              <s:textfield id="idCard" name="userinfo.idCard" maxlength="18"/></td>          
	                            </tr>
	                            <tr>
	                            ...
	                            <td  width="14%" height="28" align="right">市：</td>
	                             <td width="36%" class="fsBlack">
	                              ...
	                              <td width="36%" class="fsBlack">
	                              <s:textfield id="moblie" name="userinfo.moblie" maxlength="11"/></td>
	                            </tr>
	                            <tr>
	                             <td width="14%" height="28" align="right">固定电话：</td>
	                              <td width="36%" class="fsBlack"><s:textfield id="tel" name="userinfo.tel" maxlength="12"/><span class="noticeMsg">(区号-电话)</span></td>
