...
<%@include file="alterpawST_validate.jsp"%>


  <s:form id="alter_pawform" action="pawSetST" method="post">
        ...
        <td align="center">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="60%" align="left"><label><s:password id="oldPass" name="oldPass" /></label></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="30" align="right"><s:text name="password.new_pass1" />：</td>
                              <td width="60%" align="left"><label><s:password id="newPass1" name="newPass1"   /></label></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="30" align="right"><s:text name="password.new_pass2" />：</td>
                              <td width="60%" align="left"><label><s:password id="newPass2" name="newPass2"   /></label></td>
                              <td>&nbsp;</td>
                            </tr>
