...
function real_fudongInfoShow(TerminalViBean){
	...
	document.getElementById("real_STU_NUM").innerHTML = real_nullToZore(TerminalViBean.STU_NUM)+"/"+real_nullToZore(TerminalViBean.LIMITE_NUMBER)+"&nbsp;(人)";
	...
	document.getElementById("real_OIL_INSTANT").innerHTML = real_nullToZore(TerminalViBean.OIL_INSTANT)+"&nbsp;L/h";
