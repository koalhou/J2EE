...
<!-- 不同内容 -->
	...
	<!--  <div id ="MapbarDivNO" style="position: absolute; left:160px; top: 300px; z-index: 1000;">©2011 MapABC - GS(2010)6011</div>-->
	   ...
	   <div id="alarmParm" class="alarmParam" align="center">
	   		<table style="width: 100%" border="0" cellpadding="0" cellspacing="0" >
	   			<tr align="center">
	   				<td ><input type="checkbox" name="load_alarm_event" id="load_alarm_event1" checked="checked" alarmid="1" onclick="showErrButton()"/></td>
	   				<td>超速告警</td>
	   				<td><input type="checkbox" name="load_alarm_event" id="load_alarm_event2" checked="checked" alarmid="2" onclick="showErrButton()"/></td>
	   				<td>乘车异常</td>
	   				<td><input type="checkbox" name="load_alarm_event" id="load_alarm_event3" checked="checked" alarmid="3" onclick="showErrButton()"/></td>
	   				<td>紧急告警</td>
	   				<td><input type="checkbox" name="load_alarm_event" id="load_alarm_event4" checked="checked" alarmid="4" onclick="showErrButton()"/></td>
	   				<td>开门告警</td>
	   				<td><input type="checkbox" name="load_alarm_event" id="load_alarm_event5" checked="checked" alarmid="5" onclick="showErrButton()"/></td>
	   				<td>车辆故障</td>
	   				<td><img border="0" src="../newimages/dayinclose.png" style="cursor: pointer;" id="goup" onclick="dispayAlarmDv(0);"/></td>
	   			</tr>
	   		</table>
<!-- 			<span class="position0" style="line-height: 22px;over-flow: hidde;"><input type="checkbox" name="load_alarm_event" id="load_alarm_event1" checked="checked" alarmid="1" onclick="showErrButton()"/></span> -->
<!-- 			<span class="position2" style="line-height: 22px;">超速告警</span> -->
<!-- 			<span class="position0" style="line-height: 22px;over-flow: hidde;"><input type="checkbox" name="load_alarm_event" id="load_alarm_event2" checked="checked" alarmid="2" onclick="showErrButton()"/></span> -->
<!-- 			<span class="position2" style="line-height: 22px;">乘车异常</span> -->
<!-- 			<span class="position0" style="margin-top: -1px;"><input type="checkbox" name="load_alarm_event" id="load_alarm_event3" checked="checked" alarmid="3" onclick="showErrButton()"/></span> -->
<!-- 			<span class="position2" style="margin-top: -1px;">紧急告警</span> -->
<!-- 			<span class="position0" style="margin-top: -1px;"><input type="checkbox" name="load_alarm_event" id="load_alarm_event4" checked="checked" alarmid="4" onclick="showErrButton()"/></span> -->
<!-- 			<span class="position2" style="margin-top: -1px;">开门告警</span> -->
<!-- 			<span class="position0" style="margin-top: -1px;"><input type="checkbox" name="load_alarm_event" id="load_alarm_event5" checked="checked" alarmid="5" onclick="showErrButton()"/></span> -->
<!-- 			<span class="position2">车辆故障</span> -->
<!-- 	   		<img   src="../newimages/dayinclose.png" style="margin-top: 2px;cursor: pointer;" id="goup" onclick="dispayAlarmDv(0);"/> -->
	   ...
	   <div>
	 	<table width="100%" height="5" cellpadding="0" cellspacing="0" border="0" >
			...
			<div class="arr_bar">
			   	<div class="arr_bar_l" style="left:5px;">
	  				<a href="#;" onclick="dispayAlarmDv(1)"><span class="position2" >加载告警事件</span></a>
				</div>
			    <div class="arr_bar_c">
