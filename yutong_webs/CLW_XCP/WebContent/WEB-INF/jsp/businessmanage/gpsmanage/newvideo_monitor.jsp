...
<s:if test="terminalViBean.VIDEO_FACTORY=='YW'">
	...
	<table  border="0" align="center" cellpadding="0"
		cellspacing="4" >
		<tr>
			<td align="center" valign="middle"><object id="ocxyw"
				width="490px" height="380px"
				classid="clsid:6A4D7CA5-03B1-4A5B-97C2-A24AE5A87EA9"
				codebase="<s:url value='/codebase/mediacontrol.cab' />#version=8,1,0,9854">
			</object></td>
		</tr>
	</table>
	</div>
...
<div id="carmera1" class="camera_box" style="display:none">
	...
	<div class="check_box">
      ...
      <div style="margin: 3px 5px 3px 5px"><span class="position3"><input name="routeway2" type="checkbox" value="4" /></span><span class="position4">司机</span></div>
	</div>
	<div class="newlist-sech2" style="width:110px;float:left"><a href="#" class="btn-blue2" onfocus="this.blur()" onclick="postPhoto('HI')" style="margin-right: 15px;">拍照</a></div>
	<div class="newlist-sech2" style="width:80px; height:25px;" ><a href="#" onclick="showDownPage()" style="margin-right: 15px;">不能播放？</a></div>
</div>
<!-- 原有存储路径设置部分
...
<div id="camera_boxda" class="camera_box" style="display:none">
	...
	<div class="check_box">
      ...
      <div><span class="position3"><input name="routeway2" type="checkbox" value="4" /></span><span class="position4">司机</span></div>
	</div>
	<div class="list-sech2" style="width:80px;float:left"><a href="#" class="btn-blue2" onfocus="this.blur()" onclick="postPhoto('DA')">拍照</a></div>
	<div class="newlist-sech2" style="width:75px; height:25px;" ><a href="#" onclick="showDownPage()" style="margin-left: 15px;">不能播放？</a></div>
</div>
</s:if>
<s:if test="terminalViBean.VIDEO_FACTORY=='YW'">
<div id="camera_boxyw" class="camera_box" style="display:none">
	<h2 style=" padding-top:1px;">摄像头：</h2>
	<div class="check_box">
	  <div><span class="position3"><input name="routeway2" type="checkbox" value="1" checked="checked" /></span><span class="position4">整车</span></div>
      <div><span class="position3"><input name="routeway2" type="checkbox" value="2" checked="checked" /></span><span class="position4">路况</span></div>
	...
	<div class="list-sech2"><a href="#" class="btn-blue2" onfocus="this.blur()" onclick="postPhoto('YW')">拍照</a></div>
</div>
</s:if>
</div>
