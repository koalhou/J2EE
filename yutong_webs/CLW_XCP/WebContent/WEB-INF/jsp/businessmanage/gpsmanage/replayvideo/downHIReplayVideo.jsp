	...
	$(document).ready( function() {
		...
		if (geturlvalue) {
			for (var i=0;i<geturlvalue.length;i++) {
				...
				if(geturlvalue[i].substring(0,geturlvalue[i].indexOf("="))=="m_szRegIP"){
					m_szRegIP=geturlvalue[i].substring(geturlvalue[i].indexOf("=")+1);
				}
				if(geturlvalue[i].substring(0,geturlvalue[i].indexOf("="))=="m_iRegPort"){
					m_iRegPort=geturlvalue[i].substring(geturlvalue[i].indexOf("=")+1);
				}
				if(geturlvalue[i].substring(0,geturlvalue[i].indexOf("="))=="m_user"){
					m_user=geturlvalue[i].substring(geturlvalue[i].indexOf("=")+1);
				}
				if(geturlvalue[i].substring(0,geturlvalue[i].indexOf("="))=="m_password"){
					m_password=geturlvalue[i].substring(geturlvalue[i].indexOf("=")+1);
				}
			}
		}
