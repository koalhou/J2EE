...
function postMsg(){
	...
	if(document.getElementById("saveinfo").checked){
		...
		var typevalue = setInfoType();
		GPSDwr.postSendMsgS(vin,trim(sendmsg),userid,typevalue,postMsg_CallBack);
	}	
