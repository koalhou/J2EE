...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
							...
							<div class="workLink">
                              ...
                              <div class="car-info">
                                 ...
                                 无</td></tr></table> </div>
                                 <a id="chuli" href="#" class="btn-blue4 newalarm_btn_p304" onclick="chuli()" style="display: none"><s:if test="#session.perUrlList.contains('111_3_1_12_7')">处理</s:if><s:else>查看详情</s:else></a>
                               </div>         
                ...
                <!--dyy_20120817 end-->
                                 ...
                                 <s:if test='#request.alarmmanage.alarm_type_id=="\'32\'"'>
                                 ...
                                 <a id="deal3" href="#" onclick="changetab(this,3)"  class="alarm_tabs">车辆故障</a>
                                 </s:else>
