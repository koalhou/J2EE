...
function pickedstarttime(){
	...
	if(idays> 90){
		enddate.setTime(startdate.getTime() + 1000*60*60*24*90);
	}
	//var str1 = startdate.pattern("yyyy/MM/dd");
	//var str2 = enddate.pattern("yyyy/MM/dd");
	$dp.$('end_time').value=enddate.pattern("yyyy-MM-dd") ;
}
...
function pickedendtime(){
	...
	if(idays> 90){
		startdate.setTime(enddate.getTime() - 1000*60*60*24*90);
	}
	
	$dp.$('start_time').value=startdate.pattern("yyyy-MM-dd") ;
}
</script>