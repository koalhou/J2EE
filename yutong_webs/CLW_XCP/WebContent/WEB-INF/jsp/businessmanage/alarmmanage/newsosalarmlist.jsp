...
<%@include file="/WEB-INF/jsp/common/taglibs.jsp"%>
                          <div class="titleBar">
							...
							<div class="workLink">
                              ...
                              <div class="car-info">
                                 ...
                                 <a id="chuli" href="#" class="btn-blue4 newalarm_btn_p304" onclick="chuli()" style="display: none"><s:if test="#session.perUrlList.contains('111_3_1_12_5')">处理</s:if><s:else>查看详情</s:else></a>
                              </div>         
              	              ...
              	              <!--dyy_20120817 start-->
                                    <table border="0" cellspacing="0" cellpadding="0">
  					                    <tr>
  					                     ...
  					                     <tr>
                    	                     <td class="alarm_title">驾驶员：</td>
    					                     <td>
    					                     <input id="drivername1" type="text" style="background:url(../newimages/input_bg_137.png) no-repeat left top; border:none; width:132px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             <td class="alarm_title">跟车老师：</td>
    					                     <td>
                        	                 <table border="0" cellspacing="0" cellpadding="0">
                            	              <tr>
                                	            <td width="125"><input id="tearcher1" type="text" style="background:url(../newimages/input_bg_101.png) no-repeat left top; border:none; width:96px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                                <td class="alarm_title">乘员人数：</td>
                                                <td width="120"><input id="chengce1" type="text" style="background:url(../newimages/pop_read_bg_2.gif) no-repeat left top;; border:none; width:115px; height:22px; text-indent:5px; padding-right:5px; line-height:22px;text-align:center;" readonly="readonly"/></td>
                                             </tr>
                                            </table>
                                            </td>
                                            <td></td>
                ...
                <!--dyy_20120817 end-->
           	                    ...
           	                    <div class="alarm_tab">
                                  <a id="deal0" href="#" onclick="changetab(this,1)" class="alarm_tabs">紧急告警</a>
                                  <a id="deal2" href="#" onclick="changetab(this,2)">超速告警</a>
                                  <a id="deal1" href="#" onclick="changetab(this,3)">车辆故障</a>
                                   <s:if test="3==#session.adminProfile.en_mould">	
                                  <a id="deal1" href="#" onclick="changetab(this,4)">异常乘车</a>
                                   </s:if>
                                </div>
