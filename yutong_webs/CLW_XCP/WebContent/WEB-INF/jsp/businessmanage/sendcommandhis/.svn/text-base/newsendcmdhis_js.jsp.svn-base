...
jQuery(function() {
	...
	gala.flexigrid({
		...
		colModel : [
		    		...
		    		{display: '指令状态', name : 'deal_state', width : calcColumn(0.2,126,250), sortable : true, align: 'center',process: reWriteflag},
		    		{display: '下发时间', name : 'operate_time', width :calcColumn(0.26,200,250), sortable : true, align: 'center'},
