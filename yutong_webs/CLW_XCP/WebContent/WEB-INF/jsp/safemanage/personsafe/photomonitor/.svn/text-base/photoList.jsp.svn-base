...
<div id="wrapper">
							...
							<div class="photo-sech">
								<div class="div_float">
									<font>触发类型:</font> <select id="photo_event" name="photo_event" onchange="searchList();">
										...
										<option value="0">下发指令拍照</option>
										<option value="1">终端定时拍照</option>
	...
	<iframe id="iframeshowArea" name="iframeshowArea" src='' height="545px" width="100%" frameborder="0" scrolling="no"></iframe>
	</div>
	<!-- 弹出层（相册）结束 -->
	</div><!-- content结束 -->
