				...
				<td width="18px"  bgcolor="#E9E9E9" valign="top" class="leftline" id="middeldiv" style="display: none;">
			     ...
			     <td valign="top">
			     	<div id="content_rightside">
				        <div class="titleBar">
				         <div class="title"><s:text name="menu3.anquan" /></div>
			 ...
			 <s:hidden id="vehicle_vin" name="baddetail.vehicle_vin"></s:hidden>
				<div id="viloationDetail" class="chartDetail_c" style="display:none;">
				 	<div class="chartDetail_title" id="viloationTitle">
				     	<img src="<s:url value='/newimages/chartDetail_t_l.gif'/>" class="lt"/>
				        <img src="<s:url value='/newimages/chartDetail_t_r.gif'/>" class="rt"/>违规驾驶详情
				    ...
				    <div class="chartDetail_cent" style="height:450px;">
					    <div class="chartDetail_c_c">
					     	<div id="viloationMap" style="width: 750px;height:200px;"></div>
				     	</div>
				        <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
				           <tr>
				             <td width="10" height="40">&nbsp;</td>
				             <td width="65"><strong>事件名称：</strong></td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="32" checked="checked" onclick="searchList()"/>
				             <label for="checkbox2"></label></td>
				             <td>超速告警</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="33" checked="checked" onclick="searchList()"/></td>
				             <td>超时驾驶告警</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="54" checked="checked" onclick="searchList()"/></td>
				             <td>未鉴权驾驶告警</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="72" checked="checked" onclick="searchList()"/></td>
				             <td>超载告警</td>
				           </tr>
				        </table>
