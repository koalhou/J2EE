...
<body>
	...
	<%@include file="/WEB-INF/jsp/common/header.jsp"%>
		<div id="content">
			...
			<iframe id="iframeEngine" width="100%" height="370" frameborder="0" scrolling="auto" src="" ></iframe>
		</div>
...
<script>
		...
		var engineUrl = "http://"+addressUrl+"/CLW_ZSPT/accesslogin.shtml?ptFlag=1&ptParam=setStation&accessFlag=1";
