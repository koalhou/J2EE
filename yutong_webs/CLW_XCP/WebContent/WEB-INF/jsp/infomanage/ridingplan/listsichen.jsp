					...
					<tr>
						...
						<table border="0" cellspacing="4" cellpadding="0">
							<tr>
								<td>
								跟车老师姓名：
								<s:textfield id="sichen_name" name="sichenInfo.steward_name" maxlength="32" cssClass="input120" onkeypress="if(event.keyCode==13){searchsichen();}"/>&nbsp;&nbsp;
								</td>
...
function searchsichen() {
	jQuery('#gala').flexOptions({
		newp: 1,
		params: [{name: 'sichenInfo.steward_name', value: formatSpecialChar(jQuery('#sichen_name').val()) },	
