					...
					<tr>
						...
						<table border="0" cellspacing="4" cellpadding="0">
							<tr>
								<td>
								驾驶员姓名：
								<s:textfield id="driver_name" name="driverInfo.driver_name" maxlength="32" cssClass="input120" onkeypress="if(event.keyCode==13){searchDriver();}"/>&nbsp;&nbsp;
								</td>
	 ...
	 gala.flexigrid({
	  ...
	  colModel : 
		  [ 
			...
			{display: '驾驶员姓名', name : 'DRIVER_NAME', width : 150, sortable : false, align: 'center', escape:true},
