...
<body>
			...
			<s:hidden id="user_org_id" name="user_org_id"/>
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			        ...
			        <tr>
				        <td class="reportInline">
							...
							<table width="100%" cellspacing="0" style=" background: #fff url(../images/listTitle_bg.gif) repeat-x left top; line-height: 22px; border: 1px solid #c3c3c3;">
								<thead>
									<tr>
										<!-- <th width="40px" align="left">编码</th> -->
										<th width="70px" align="center">名称</th>
										<th width="60px" align="left">状态</th>
									</tr>
									<tr>
									    <!--<td width="40px" align="left">${ridingReady.route_id}</td>-->
									    
									    <td width="70px" align="center">${ridingReady.route_name}</td>
									    <td width="60px" align="left"><s:if test="1!=ridingReady.type">上学</s:if><s:else>放学</s:else></td>
									</tr>
								</thead>
							</table>
				        </td>
			      ...
			      <td id="leftTabtd" valign="top" bgcolor="#E9E9E9" width="24" style="display:none">
					...
					<s:form id="updateridingPlanForm" action="ridingupdate" method="post"> 
			                     ...
			                     <td><table border="0" cellspacing="8" cellpadding="0">
			                       <tr>
			                         ...
			                         <td id="vln">车辆选择：
			                             ...
			                             <s:hidden id="vehicle_vin_old" name="ridingReady.vehicle_vin_old" cssClass="input120"/>                                                                                                     
			                         </td>
			                         <td id="vln">驾驶员选择：
			                         ...
			                         <td id="vln">跟车老师选择：
			                             ...
			                             <s:hidden id="trip_id" name ="ridingReady.trip_id"/>
			                             <s:hidden id="type" name ="ridingReady.type"/>                        
			                         </td>
			                       </tr>
			                     </table></td>
			                   </tr>
								  ...
								  <tr>
								   <td>
									...
									<table width="100%" border="0" cellspacing="8" cellpadding="0">
			                                 	<tr>
			                  						 <td width="90%"></td>
			                  						 <s:if test="#session.perUrlList.contains('111_3_3_7_3')">
			                  						 <td><a href="#" onclick="submitForm()" class="sbutton">修改</a></td>
			                  						 </s:if>
			                  						 <s:if test="#session.perUrlList.contains('111_3_3_7_4')">
			                  						 <td><a href="javascript:deleteRidingPlan()" class="sbutton">删除</a></td>
			                  						 </s:if>
	...
	<%@include file="ridingUpdate_validate.jsp"%>
</body>
</html>