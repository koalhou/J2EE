...
<div id="wrapper">
  ...
  <div id="content">
  <s:form id="smsImport_form" action="importSms" method="post" enctype="multipart/form-data">
    <s:hidden id="page" name="page" />
    <s:hidden id="pageSize" name="pageSize" />
    
    <table id="smsTable" width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
		<td height="36" valign="top">
			<div class="toolbar">
				<div class="contentTil">短信提醒信息</div>
			</div>
		</td>
	</tr>
    ...
    <table class="msgBox2" width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="32" background="<s:url value='/images/msg_title_bg.gif'/>" align="left">
          <span class="msgTitle">信息导入(<font color="red">导入操作后将覆盖原有已设置信息</font>)
          </span>
        </td>
      </tr>
      <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="fsBlack" align="left">
                ...
                <a href="<s:url value='/uploadlogo/StuSmsInformation.xls' />"><s:property value="getText('file.template.download')" /></a>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td class="btnBar"> 
          <a href="#" class="buttontwo" onclick="goBack('smsmanage.shtml')">
...
<%@include file="smsImport_validate.jsp"%>
</body>
</html>
