...
<div id="wrapper">
	...
	<div id="content">
		<s:form id="editsms_form" action="editSms" method="post">
			<s:hidden name="page" />
				...
				<tr>
					<td valign="top">
						<table class="msgBox2" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-right:0px; padding-left:0px; width:800px;">
							<tr>
								<td height="32">
									<span class="msgTitle">&nbsp;&nbsp;修改短信提醒</span>
								</td>
							</tr>
							<tr>
								<td>
						    		...
						    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
						    			...
						    			<tr>
						    				<td height="28">
						    				  ...
						    				  &nbsp;&nbsp;称谓：
						    				  <s:textfield id="relativeType" name="parentsList[%{#stat.index}].relativeType" value="%{parentsList[#stat.index].relativeType}" maxlength="10"/>
						    				  <span class="noticeMsg">*</span></td>
						    				<td>姓名：
						    				  <s:textfield id="relativeName" name="parentsList[%{#stat.index}].relativeName" value="%{parentsList[#stat.index].relativeName}" maxlength="10"/>
							...
							<tr>
								<td class="btnBar" style="padding-top: -5px">
									...
									<s:url id="delete" action="deleteSms">
...
<%@include file="editsms_validate.jsp"%>
</body>
</html>
