...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
      ...
      <div id="statusManger">
      	<br/>
        <div class="alarm_tab">
           <a id="deal0" href="#" onclick="changetab(this,1)">驾驶时长</a>
           <a id="deal2" href="#" onclick="changetab(this,2)" class="alarm_tabs">刷卡记录</a>
         </div>
         <div class="alarm_select">
	            ...
	            <span class="alarm_sel_txt">状态：</span>
	            <div class="alarm_sel_c">
                 	<select id="stateType" name="stateType" style=" width:100px;" id="time_option" onchange="changeState(this)">
                 	    <option value="" selected="selected">请选择</option>
	                	<option value="0">上车刷卡</option>
	                	<option value="1">下车刷卡</option>
	               	</select>
                </div>
				 <span class="alarm_sel_txt">车牌号：</span>
	             <div class="alarm_sel_c">
					<s:textfield id="vehicle_ln" name="vehicle_ln" cssClass="input100" maxlength="7" onkeypress="if(event.keyCode==13){searchRecordList();}"/>
				 </div>
              	 <div>
	          		<a href="#" onclick="searchRecordList()" class="alarm_btn" >查询</a>
	             </div>
				 <div class="export_alarm1">
	                <a href="#" class="export_alarm1_c2" onclick="exportRecord()">导出</a>
	             </div>
	             <div class="alarm_t_c">
	              ( 不能查询当日数据 )
	              </div>
                 <div class="alarm_t_c">
                    <table id="gala2" width="100%">
                 	</table>
                 </div>
        </div>
        </div>
        <s:form id="export_record_form" action="" method="post">
			...
			<s:hidden id="exportObj.state" name="exportObj.state"/>
			<s:hidden id="exportObj.vehicleLn" name="exportObj.vehicleLn"/>
		</s:form>
       <%@include file="driverRecord_js.jsp"%>
        </body>
</html>