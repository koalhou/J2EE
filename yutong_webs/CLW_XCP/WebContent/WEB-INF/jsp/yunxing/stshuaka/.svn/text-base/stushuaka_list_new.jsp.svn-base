...
<div id="wrapper">
	...
	<s:form id="export_form" action="" method="post">
		...
		<s:hidden id="queryObj.stu_class" name="queryObj.stu_class"/>
		<s:hidden id="queryObj.stu_school" name="queryObj.stu_school"/>
		<s:hidden id="queryObj.endTime" name="queryObj.endTime"/>
		<s:hidden id="queryObj.begTime" name="queryObj.begTime"/>
		<s:hidden id="queryObj.VIN" name="queryObj.VIN"/>
		<s:hidden id="queryObj.st_ride_flag" name="queryObj.st_ride_flag"/>
	</s:form>
