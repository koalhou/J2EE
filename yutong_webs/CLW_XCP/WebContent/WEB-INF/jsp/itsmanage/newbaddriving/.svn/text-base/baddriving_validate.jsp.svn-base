		 ...
		 var gala = jQuery('#gala');
			gala.flexigrid({
				...
				colModel : [
				    		...
				    		{display: '<s:text name="common.kongdanghuaxing" />', name : 'gear_glide_num', width : 100, sortable : true, align: 'center', process:sumStyle,hide:false,toggle:false},
				    		{display: '<s:text name="common.kongdanghuaxingtime" />', name : 'gear_glide_time', width : 100, sortable : true, align: 'center', process:sumStyle,hide:false,toggle:false},
	...
	function getDetailList(){
		...
		detailgrid.flexigrid({
			...
			colModel : [
			    		...
			    		{display: '<s:text name="common.driver" />', name : 'driver_name', width : 50, sortable : true, align: 'center',hide:true,toggle:false},
			    		...
			    		{display: '位置', name : 'alarm_address', width : 120, sortable : true, sortable : false,align: 'center'},
