				    ...
				    <div class="chartDetail_cent" style="height:450px;">
				        ...
				        <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
				           <tr>
				             ...
				             <td>超速告警</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="46" checked="checked" onclick="searchList()" /></td>
				             <td>空档滑行</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="49" checked="checked" onclick="searchList()" /></td>
				             <td>超转告警</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="50" checked="checked" onclick="searchList()" /></td>
				             <td>超长怠速</td>
				             <td><input type="checkbox" name="alarm_type_id_name" value="51" checked="checked" onclick="searchList()" /></td>
				             <td>怠速空调</td>
				           </tr>
				        </table>
