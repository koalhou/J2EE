...
public class PaginationAction extends BaseAction {
     ...
     * 用于左侧树分页
     */
    protected String leftPageBar;

    public String getLeftPageBar() {
        return leftPageBar;
    }

    public void setLeftPageBar(String leftPageBar) {
        this.leftPageBar = leftPageBar;
    }
    ...
    protected int getStartPage(Service service, Class clazz)
        ...
        this.leftPageBar = PageHelper.getLeftPageBar(pageObj);
