...
public class Page {
    ...
    public String getLeftpageTemplate() {
        return LeftpageTemplate;
    }

    public void setLeftpageTemplate(String leftpageTemplate) {
        LeftpageTemplate = leftpageTemplate;
    }

    private String LeftpageTemplate = "leftPage.ftl";
