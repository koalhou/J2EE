...
public interface VehicleManageService extends Service {
    ...
    void updateDriverInfo(VehcileInfo vechinfo,String OldLicense)
            throws BusinessException;
    
    void updateTripInfo(VehcileInfo vechinfo)
            throws BusinessException;
    
    void deleteDriverInfo(VehcileInfo vechinfo,String OldLicense)
            throws BusinessException;
}
