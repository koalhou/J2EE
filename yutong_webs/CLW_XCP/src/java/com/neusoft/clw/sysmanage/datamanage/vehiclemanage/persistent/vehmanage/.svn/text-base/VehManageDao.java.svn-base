package com.neusoft.clw.sysmanage.datamanage.vehiclemanage.persistent.vehmanage;
...
public class VehManageDao extends ExtendSqlMapDao {
    /**
     * 车辆分配时批量更新ORGID
     */
