...
public class EntiManageDwr extends BaseAction {
    ...
    public EnterpriseDataInfo getEnterpriseDataInfoToShow(String enterId) {
        ...
        try {
            ...
            // 保存country、province、city的code信息
            enterInfo.setEnterprise_country_code(SqlStringUtil.getNoNull(enterInfo
                    .getEnterprise_country()));
            enterInfo.setEnterprise_province_code(SqlStringUtil.getNoNull(enterInfo
                    .getEnterprise_province()));
            enterInfo.setEnterprise_city_code(SqlStringUtil.getNoNull(enterInfo
                    .getEnterprise_city()));
