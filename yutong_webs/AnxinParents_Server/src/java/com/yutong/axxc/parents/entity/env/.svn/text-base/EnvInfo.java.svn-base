 ...
 */
package com.yutong.axxc.parents.entity.env;

import javax.xml.bind.annotation.XmlElement;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.yutong.axxc.parents.tools.BeanUtil.CheckBean;
import com.yutong.axxc.parents.tools.BeanUtil.Require;
